        ...
        if (!t.id || !i("#" + t.id)[0]) {
            switch ("string" == typeof t.area && (t.area = "auto" === t.area ? ["", ""] : [t.area, ""]), t.shift && (t.anim = t.shift), 6 == r.ie && (t.fixed = !1), t.type) {
                ...
                case 2:
                    ...
                    t.content = [t.content,"no"];//不允许有滚动条
...
//todo 获取第一个的top和left，再加上div的高度，然后再进行偏移
        if(true){
...
//        debugger;
        ...
        //e.offsetLeft = 500;
            ...
            var dytop = $(".search").length == 0 ? $("#contentif").contents().find(".search").eq(0).height() + $("#contentif").contents().find(".dock-container").last().offset().top  : $(".search").eq(0).height() + $(".dock-container").last().offset().top ;
            var dyleft = $(".dock-container").length == 0 ? $("#contentif").contents().find(".dock-container").eq(0).offset().left : $(".dock-container").eq(0).offset().left;
            i.css({
                top: dytop+80*0.8,//这里是搜索框的top+.dock-container的top+图片的高度
                left: dyleft-12-10
            })
        }
    }, s.pt.tips = function () {
