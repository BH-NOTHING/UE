            ...
            domUtils.on(canvas, ["mousedown", "mousemove", "mouseup", "mouseout"], function(e) {
                ...
                switch (e.type) {
                    case 'mousedown':
                        ...
                        /*author: Rum   这里加上滚动条的偏移量*/
                        var div = document.getElementById('J_scrawl');
                        var left  = div.scrollLeft;
                        var right = div.scrollTop;
                        // endX += left;
                        // endY += right;
                        startX += left;
                        startY += right;
                        ...
                        /*author: Rum   这里加上图片压缩拉伸比例*/
                        var canvas = document.getElementById('J_brushBoard');
                        var rw = parseFloat(canvas.style.width) / canvas.getAttribute('width');
                        var rh = parseFloat(canvas.style.height) / canvas.getAttribute('height');
                        startX /= rw;
                        startY /= rh;
                        /*end*/
                        context.beginPath();
