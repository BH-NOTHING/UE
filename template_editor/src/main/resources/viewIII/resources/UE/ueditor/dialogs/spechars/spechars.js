 ...
 */
var arr1 = "↓,↑,mol, Cap - BS, 10 ^ 6 / L, nmol / L, Ω, cmH2O, g, ml, mg, ml / h, 次 / 分, 升 / 分, mmol / L, 10 ^ 12 / L, 10 ^ 9 / L, KIU / L, R / s, U / L, U / ml, g / L, kPa, mIU / L, mg / L, mg / dl, ml / s, mmHg, mol / 24h, mol / L, pmol / L,～,±,×,√,≤,≥,℃,‰,①,②,③,④,⑤,⑥,⑦,⑧,⑨,⑩,Ⅰ, Ⅱ, Ⅲ, Ⅳ, Ⅴ, Ⅵ, Ⅶ, Ⅷ, Ⅸ, Ⅹ, Ⅺ, Ⅻ,＜,＞,ｇ, α, β, γ, δ, κ, λ, μ, μg, μg / L, μmol, μmol / 24h, μmol / L,℉,┃,┓,┛,≈";

var charsContent = [
    {name: "cyfh", title: lang.cyfh, content: toArray(arr1)},
...
(function createTab(content) {
    for (var i = 0, ci; ci = content[i++];) {
        ...
        for (var j = 0, con; con = cons[j++];) {
            ...
            charSpan.innerHTML = con.replace(/\s+/g, "");//去除所有空格
