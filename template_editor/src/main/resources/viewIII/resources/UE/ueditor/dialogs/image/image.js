...
(function () {
    ...
    function initButtons() {
        ...
        dialog.onok = function () {
            ...
            if(list) {
                var dform = document.querySelector('.my-radio-form');
                var radios = dform.querySelectorAll('.my-radio');
                var column = 2;
                ...
                editor.execCommand('insertimage', list, +column);
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                accept: {
                    ...
                    mimeTypes: 'accept="image/gif,image/jpeg,image/jpg,image/png,image/svg"'  //浏览器bug通配符引发打开慢的问题
                    // mimeTypes: 'image/*'
                },
            ...
            uploader.on('all', function (type, files) {
                switch (type) {
                    ...
                    case 'startUpload':
                        /* 添加额外的GET参数 */
                    	actionUrl += (actionUrl.indexOf('?') == -1 ? '?' : '&') +"WEB_URL_FASTDFS="+editor.options.WEB_URL_FASTDFS;
                    	console.log("image.js----actionUrl:"+actionUrl);
        ...
        getInsertList: function () {
            ...
            for (i = 0; i < this.imageList.length; i++) {
                ...
                prefix = data.isFastdfsRes==1?data.tracker_prefix : editor.options.WEB_URL;
                list.push({
                    src: prefix + data.url,
                    ...
                    isFastdfsRes: data.isFastdfsRes//用于判断上传类型
                });
            }
            return list;
        }
