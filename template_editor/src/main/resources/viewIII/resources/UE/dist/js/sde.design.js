 ...
 * createtime: Thu, 18 May 2017 05:17:14 GMT
 */
!
function(A) {
    function e(n) {
...
default = {
        ...
        ajax: function(A) {
            function e() {
                function A(e, t) {
                    function i(e, t, i) {
                        ...
                        "object" === ("undefined" == typeof t ? "undefined": n(t)) && null !== t ? r = r.concat(A(t, e)) : (e = encodeURIComponent(e), t = encodeURIComponent(t), r.push(e + "=" + t)),
                        r
                    }
                    var r, o = [];
                    if ("[object Array]" == Object.prototype.toString.call(e)) for (var a = 0,
                    d = e.length; a < d; a++) r = e[a],
                    o = o.concat(i("object" == ("undefined" == typeof r ? "undefined": n(r)) ? a: "", r, t));
                    else if ("[object Object]" == Object.prototype.toString.call(e)) for (var l in e) r = e[l],
                    o = o.concat(i(l, r, t));
                    return o
                }
                function e(A) {
                    for (var e = A.split("&"), t = 0, n = e.length; t < n; t++){
                        var name = encodeURIComponent(e[t].split("=")[0]),
                        value = encodeURIComponent(e[t].split("=")[1]);
                        e[t] = name + "=" + value;
                    }
                    return e
                }
                d && ("string" == typeof d ? d = e(d) : "object" === ("undefined" == typeof d ? "undefined": n(d)) && (d = A(d)), d = d.join("&").replace("/%20/g", "+"), "get" !== a && "jsonp" !== c || (o += o.indexOf("?") > -1 ? o.indexOf("=") > -1 ? "&" + d: d: "?" + d))
            }
            function t() {
                ...
                A.src = o + (o.indexOf("?") > -1 ? "&": "?") + "callback=" + t,
                A.type = "text/javascript",
                document.body.appendChild(A),
                i(t, A)
            }
            function i(A, e) {
                void 0 !== s && (E = setTimeout(function() {
                    "jsonp" === c ? (delete window[A], document.body.removeChild(e)) : (w = !0, B && B.abort()),
                    console.log("timeout")
                },
                s))
            }
            function r() {
                ...
                B = A(),
                B.open(a, o, g),
                "post" !== a || l ? l && B.setRequestHeader("Content-Type", l) : B.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;charset=UTF-8"),
                B.onreadystatechange = function() {
                    if (4 === B.readyState) {
                        ...
                        B.status >= 200 && B.status < 300 || 304 == B.status ? p(B.responseText) : m(B.status, B.statusText)
                    }
                },
                B.send("get" === a ? null: d),
                i()
            ...
            var o = A.url || "",
            a = (A.type || "get").toLowerCase(),
            d = A.data || null,
            l = A.contentType || "",
            c = A.dataType || "",
            g = void 0 === A.async || A.async,
            s = A.timeOut,
            u = A.before ||
            function() {},
            m = A.error ||
        ...
        deepCopy: function() {
            ...
            /*for ("boolean" == typeof a && (c = a, a = arguments[d] || {},
                d++), "object" === ("undefined" == typeof a ? "undefined": n(a)) || this.isFunction(a) || (a = {}), d === l && (a = this, d--); d < l; d++) if (null != (r = arguments[d])) for (i in r) A = a[i],
                t = r[i],
...
*/
            "boolean" == typeof a && (c = a, a = arguments[d] || {}, d++),
            "object" === ("undefined" == typeof a ? "undefined": n(a)) || this.isFunction(a) || (a = {});
            for (d === l && (a = this, d--); d < l; d++){
                if (null != (r = arguments[d])){
                    for (i in r){
                        A = a[i], t = r[i];
                        if(a !== t ){
                            if(c && t && (this.isPlainObject(t) || (e = this.isArray(t))) ){
                                (e ? (e = !1, o = A && this.isArray(A) ? A: []) : o = A && this.isPlainObject(A) ? A: {}, a[i] = this.deepCopy(c, o, t))
                            }else{
                                void 0 !== t && (a[i] = t)
                            }
                        }
...
function(A, e, t) {
    ...
    e.default = {
        clickTab: function(A){
            if($(A.target).attr("onoff") == "false"){
                      if (! ("LI" !== A.target.nodeName || A.target.className.indexOf("tab-list") < 0)) {
                        ...
                        var t = e[0];
                        //king 20170628工具条按钮
                        for (var n = A.target, i = n.parentNode.childNodes, r = 0, o = i.length; r < o; r++){ 
                        	void 0 !== i[r].setAttribute && i[r].setAttribute("class", "tab-list-item");
                        }
                        n.setAttribute("class", "tab-list-item tab-list-item-active");
                        var onExpand = n.getAttribute("onExpand") ;
                        /*Rum*/
                        if(!onExpand){
        	                ...
        	                if ( "LI" == n.nodeName) {
        	                    for (var a = n.getAttribute("tag"), d = document.getElementById(a), l = d.parentNode.childNodes, c = 0, g = l.length; c < g; c++){ 
        	                    	void 0 !== l[c].setAttribute && l[c].setAttribute("style", "");
        	                    }
        	                    d.setAttribute("style", "display:inline!important;")
        	                }
                        }
                        /*
                            不同地方contert的外边距不一样，添加class提供自定义
                        */
                        var content = document.getElementsByClassName("sde-editor-content")[0];
                        ...
                        removeClass(content, 'my-up-margin');
                        removeClass(content, 'my-dow-margin');
                        addClass(content, 'my-dow-margin');
                        /*end*/
                        $(A.target).attr("onoff",true);
                        $(A.target).siblings().attr("onoff",false);
                    }
            }else{
            	$(".sde-header .fold-toolbar").trigger("click");
            	$(A.target).attr("onoff",false);
            }
        ...
        createDriftingDiv: function(A, e, t) {
            ...
            if (i.className = "DriftingDiv-big", n.className = "DriftingDiv", null !== A && void 0 !== A && A.length > 0) for (var a = 0,
            d = A.length; a < d; a++) {
...
//            r.
//        default.registerEvent(n, "mouseover",
//     	   function(A) {
//     	   var oldSize = sde.__ue__.queryCommandValue( 'fontsize' )
...
function(A, e) {
    ...
    function l(A, e, t, n) {
        var i = t ? "": n.css;
        if (A.styleSheet) A.styleSheet.cssText = f(e, i);
        else {
    ...
    u = function(A) {
        var e;
        return function() {
            return "undefined" == typeof e && (e = A.apply(this, arguments)),
            e
        }
    },
    m = u(function() {
...
function(A, e, t) {
    ...
    default.registerEvent(i, "mouseover",
        ...
        r.default.registerEvent(i, "click",
        function(A) {
            if ("TD" === A.target.nodeName) {
...
function(A, e, t) {
    ...
    function i(A, e,onclick,onExpand) {
        var t = document.createElement("li");
        t.className = "tab-list-item",
        t.innerText = A,
        t.setAttribute("tag", e);
        //king 20170628工具条按钮 777
        if(onclick) t.setAttribute("onclick", onclick);
        if(onExpand) t.setAttribute("onExpand", onExpand);
        return  t
    }
    ...
    default.registerEvent(t, "click",
        function() {
            ...
            $(A).find(".tab-list .tab-list-item").attr("onoff",false);
    ...
    D = null;
    e.default = {
        renders: [l.default, g.default, u.default, p.default, E.default, f.default, M.default],
        ext_renders: [],
        ext_renders_left: [],
        editor: null,
        init: function(A) {
            if (D = this.editor, O = A, null === O) return console.error("toolbars is null!"),
            document.createElement("div");
            var e = document.createElement("ul"),
            t = document.createElement("div");
            e.className = "tab-list",
            t.className = "tab-content",
            b.default.registerEvent(e, "click", a.default.clickTab),
            b.default.registerEvent(e, "dblclick", a.default.dblclickTab);
            if (this.ext_renders_left.length > 0){
                for (var ll in this.ext_renders_left) {
                    var rll= this.ext_renders_left[ll];
                    //king 20170628工具条按钮
                    var iii = i(rll.title, rll.name,rll.onclick,rll.onExpand);//777行
                    e.appendChild(iii),
                        this.renders[ll].editor = this.editor,
                        t.appendChild(rll.init());
                }
            }
            for (var n in O) {
            	for (var o = 0, d = this.renders.length; o < d; o++) {
            		this.renders[o].name === n && (e.appendChild(i(this.renders[o].title, n)), 
            		this.renders[o].editor = this.editor, 
            		t.appendChild(this.renders[o].init(O[n])));
            	}
            }
            if (this.ext_renders.length > 0){
            	for (var l in this.ext_renders) {
            		var rl= this.ext_renders[l];
            		 //king 20170628工具条按钮
            		var ii = i(rl.title, rl.name,rl.onclick,rl.onExpand);//777行
            		e.appendChild(ii),
            		this.renders[l].editor = this.editor,
            		t.appendChild(rl.init());
            	}
            }
            var c = document.createElement("div");
            c.className = "sde-toolbar",
            c.appendChild(e),
            c.appendChild(t),
            c.appendChild(r());
            if("READONLY" == window.SDE_CONFIG.MODE) return document.createElement("div");
            return  c;
        }
    }
},
...
function(A, e, t) {
	//原代码，
	/*var styleA=".sde-select{position:absolute;display:none;border:1px solid #ccc;min-height:10px;background-color:#fefefe;overflow-y:auto}" +
	".sde-toolbar{height:30px;border-bottom:1px solid #dbdbdb;background-color:#fff;width:100%;box-shadow:0 0 3px hsla(0,0%,80%,.3);z-index:11;position:relative;overflow:hidden;clear:both}" +
	".tab-list{height:29px;background-color:#f1f1f1;border-bottom:1px solid #eee;margin:0;z-index:12;position:relative}" +
	".tab-list-item{float:left;list-style-type:none;height:30px;line-height:36px;line-height:28px;font-family:ff-tisa-web-pro-1,ff-tisa-web-pro-2,Lucida Grande,Hiragino Sans GB,Hiragino Sans GB W3,Microsoft YaHei,WenQuanYi Micro Hei,sans-serif;font-size:12px;padding:0 20px!important;background-color:#f1f1f1;cursor:pointer}" +
	".tab-list-item:hover{background-color:#ccc!important}" +
	".tab-list-item-active{background-color:#fff!important}" +
	".tab-content{margin:10px;white-space:nowrap;background-color:#fff;width:100%;z-index:11;height:auto;position:relative;overflow:hidden;clear:both}" +
	...
	".tab-content-item-panel{margin-left:6px;border-radius:2px;position:relative;top:0;left:0;height:90px;border:1px solid #d3d3d3;float:left}" +
	".tab-content-item-panel-label{display:block;text-align:center;width:auto;color:#666;border-bottom:1px solid #d3d3d3;padding:0 5px}" +
	".tab-content-item-panel-content{padding:8px 5px}" +
	".tab-content-item-panel-content-control{display:block;border:0;margin-top:2px!important;padding:2px;margin:0 0 0 2px;overflow:hidden;cursor:default}" +
	".control-disabled{background-color:#fff;opacity:.5!important}" +
	".tab-content-item-panel-content-control:hover{background-color:#d5e1f2!important}" +
	".tab-content-item-panel-content-btn0{padding:0!important}" +
	".tab-content-item-panel-content-btn,.tab-content-item-panel-content-btn0{float:left;border-radius:2px;border:1px solid #ababab;border-color:#d3d3d3;margin-right:4px;cursor:default}" +
	".tab-content-item-panel-content-btn{padding:0 2px!important}" +
	".tab-content-item-panel-content-btn:hover{background-color:#d5e1f2!important}" +
	".tab-content-item-panel-content-btn1{cursor:default;float:left;padding:2px;margin:0 0 0 1px}" +
	".tab-content-item-panel-content-btn1:hover{background-color:#d5e1f2!important}" +
	".tab-content-item-panel-content-btn2{cursor:default;float:left;border-radius:2px;border:1px solid #ababab;border-color:#d3d3d3;margin-right:4px;padding:0 0 0 2px!important}" +
	".tab-content-item-panel-content-btn2 .btn2-left:hover,.tab-content-item-panel-content-btn2 .btn2-right:hover{background-color:#d5e1f2!important}" +
	".tab-content-item-panel-content-box{padding:2px;float:left;height:57px}" +
	".tab-content-item-panel-content-box img{border:none;display:inline-block}" +
	".tab-content-item-panel-content-box:hover,.toggle-toolbar .dock-toolbar:hover,.toggle-toolbar .fold-toolbar:hover{background-color:#d5e1f2!important}body,html{margin:0}" +
	".edui-default .edui-editor{padding:" +window.SDE_CONFIG.SDE_UEPADDING +" ;border:none;box-shadow:0 0 0 1px #d1d1d1,0 0 3px 1px #ccc;border-radius:0;-webkit-border-radius:0;}" +
	"::-webkit-scrollbar{width:9px!important;height:9px!important;box-sizing:border-box}" +
	"::-webkit-scrollbar-button{width:9px!important;height:12px!important;background:url(data:image/png;base64,);background-color:transparent;background-repeat:no-repeat}::-webkit-scrollbar-button:vertical:start{background-position:0 0}::-webkit-scrollbar-button:vertical:start:hover{background-position:-10px 0}::-webkit-scrollbar-button:vertical:start:active{background-position:-20px 0}::-webkit-scrollbar-button:vertical:end{background-position:-30px 0}::-webkit-scrollbar-button:vertical:end:hover{background-position:-40px 0}::-webkit-scrollbar-button:vertical:end:active{background-position:-50px 0}::-webkit-scrollbar-button:horizontal:start{background-position:0 -11px}::-webkit-scrollbar-button:horizontal:start:hover{background-position:-10px -11px}::-webkit-scrollbar-button:horizontal:start:active{background-position:-19px -11px}::-webkit-scrollbar-button:horizontal:end{background-position:-30px -11px}::-webkit-scrollbar-button:horizontal:end:hover{background-position:-40px -11px}::-webkit-scrollbar-button:horizontal:end:active{background-position:-50px -11px}::-webkit-scrollbar-track{-webkit-border-radius:5px;background-color:rgba(0,0,0,.15)}::-webkit-scrollbar-thumb{background-color:rgba(0,0,0,.2);border:1px solid rgba(0,0,0,.21)!important;-webkit-border-radius:5px}::-webkit-scrollbar-thumb:hover{background-color:rgba(0,0,0,.4);border:1px solid rgba(0,0,0,.21)!important}::-webkit-scrollbar-thumb:active{background-color:rgba(0,0,0,.5)}::-webkit-scrollbar-corner{background-color:#f1f1f1;-webkit-border-radius:1px}::-webkit-scrollbar-track:hover{background-clip:padding-box;background-color:rgba(0,0,0,.3)}" +
	".sde .sde-header{position:fixed;top:0;left:0;z-index:1000;width:100%}" +
	".sde .sde-editor{width:" + window.SDE_CONFIG.SDE_EDITORWIDTH + ";margin:0 auto}" +
	".sde .sde-editor .sde-editor-content{margin-top:50px}" +
	".sde .sde-editor .sde-editor-footer{text-align:center;font-size:12px;color:#999;margin:20px 0}" +
	".DriftingDiv{position:fixed;margin-top:23px;border:1px solid rgba(0,0,0,.21)!important;z-index:99999;background-color:#fff}" +
	".DriftingDiv div{padding:0 5px}" +
	".DriftingDiv div:hover{background-color:#d5e1f2}" +
	".DriftingDiv .selected{background-color:#87a9da}" +
	".DriftingDiv-root{display:none}" +
	".DriftingDiv-big{position:fixed;z-index:99998;background:#000;opacity:0;top:0;left:0;width:100%;height:100%}" +
	".table-div-root{display:none}" +
	".table-div-root-bg{position:fixed;z-index:99998;background:#000;opacity:0;top:0;left:0;width:100%;height:100%}" +
	".table-div-root-content{position:fixed;z-index:99999;border:1px solid rgba(0,0,0,.21)!important;margin-top:2px}" +
	".table-div-root-content>.title{display:block;background:#e0e0e0;padding:5px 0 5px 2px;text-align:left!important}" +
	".table-div-root-content table{background:#fff}" +
	".table-div-root-content table tr td{height:10px;width:10px;margin:1px;border:1px solid rgba(0,0,0,.21)}" +
	".table-div-root-content table tr td.check{border:1px solid #87a9da}" +
	".sde-ctrl{float:left}";*/
	
	//已经移到dialogs/css/sde-icon.css中
	var styleA=".edui-default .edui-editor{padding:" +window.SDE_CONFIG.SDE_UEPADDING +" ;border:none;box-shadow:0 0 0 1px #d1d1d1,0 0 3px 1px #ccc;border-radius:0;-webkit-border-radius:0;}" +
	"::-webkit-scrollbar{width:9px!important;height:9px!important;box-sizing:border-box}" +
	"::-webkit-scrollbar-button{width:9px!important;height:12px!important;background:url(data:image/png;base64,);background-color:transparent;background-repeat:no-repeat}::-webkit-scrollbar-button:vertical:start{background-position:0 0}::-webkit-scrollbar-button:vertical:start:hover{background-position:-10px 0}::-webkit-scrollbar-button:vertical:start:active{background-position:-20px 0}::-webkit-scrollbar-button:vertical:end{background-position:-30px 0}::-webkit-scrollbar-button:vertical:end:hover{background-position:-40px 0}::-webkit-scrollbar-button:vertical:end:active{background-position:-50px 0}::-webkit-scrollbar-button:horizontal:start{background-position:0 -11px}::-webkit-scrollbar-button:horizontal:start:hover{background-position:-10px -11px}::-webkit-scrollbar-button:horizontal:start:active{background-position:-19px -11px}::-webkit-scrollbar-button:horizontal:end{background-position:-30px -11px}::-webkit-scrollbar-button:horizontal:end:hover{background-position:-40px -11px}::-webkit-scrollbar-button:horizontal:end:active{background-position:-50px -11px}::-webkit-scrollbar-track{-webkit-border-radius:5px;background-color:rgba(0,0,0,.15)}::-webkit-scrollbar-thumb{background-color:rgba(0,0,0,.2);border:1px solid rgba(0,0,0,.21)!important;-webkit-border-radius:5px}::-webkit-scrollbar-thumb:hover{background-color:rgba(0,0,0,.4);border:1px solid rgba(0,0,0,.21)!important}::-webkit-scrollbar-thumb:active{background-color:rgba(0,0,0,.5)}::-webkit-scrollbar-corner{background-color:#f1f1f1;-webkit-border-radius:1px}::-webkit-scrollbar-track:hover{background-clip:padding-box;background-color:rgba(0,0,0,.3)}" +
	".sde .sde-header{position:fixed;top:0;left:0;z-index:1000;width:100%}" +
	".sde .sde-editor{width:" + window.SDE_CONFIG.SDE_EDITORWIDTH + ";margin:0 auto}" +
...
default = {
        ...
        plugin: function(A) {
            var e = this.name,
            t = r.
        default.getUEDialog(A, e, "link/link.html", "添加链接", "width:420px;height:200px;", [{
...
function(A, e, t) {
    ...
    r = (n(i), void 0),
    o = function A() {
        var A = UE.dom.domUtils.filterNodeList(r.selection.getStartElementPath(), "p h1 h2 h3 h4 h5 h6");
...
default = {
        ...
        plugin: function(A) {
            function e(A) {
                for (var e; (e = A.parentNode) && "SPAN" == e.tagName && 1 == i.getChildCount(e,
                function(A) {
                    return ! i.isBookmarkNode(A) && !i.isBr(A)
                });) e.style.cssText += A.style.cssText,
                i.remove(A, !0),
                A = e
            }
            function t(A, e, t) {
                if (c[e] && (A.adjustmentBoundary(), !A.collapsed && 1 == A.startContainer.nodeType)) {
                    var n = A.startContainer.childNodes[A.startOffset];
                    if (n && i.isTagNode(n, "span")) {
                        var o = A.createBookmark();
                        r.each(i.getElementsByTagName(n, "span"),
                        function(A) {
                            A.parentNode && !i.isBookmarkNode(A) && ("backcolor" == e && i.getComputedStyle(A, "background-color").toLowerCase() === t || (i.removeStyle(A, c[e]), A.getAttribute("sde-model") || 0 !== A.style.cssText.replace(/^\s+$/, "").length || i.remove(A, !0)))
                        }),
                        A.moveToBookmark(o)
                    }
                }
            ...
            function n(A, n, d) {
                var l, c = A.collapsed,
                g = A.createBookmark();
                if (c) for (l = g.start.parentNode; a.$inline[l.tagName];) l = l.parentNode;
                else l = i.getCommonAncestor(g.start, g.end);
                r.each(i.getElementsByTagName(l, "span"),
                function(A) {
                    if (A.parentNode && !i.isBookmarkNode(A)) {
                        if (/\s*border\s*:\s*none;?\s*/i.test(A.style.cssText)) return void(/^\s*border\s*:\s*none;?\s*$/.test(A.style.cssText) ? i.remove(A, !0) : i.removeStyle(A, "border"));
                        if (/border/i.test(A.style.cssText) && "SPAN" == A.parentNode.tagName && /border/i.test(A.parentNode.style.cssText) && (A.style.cssText = A.style.cssText.replace(/border[^:]*:[^;]+;?/gi, "")), "fontborder" != n || "none" != d) for (var t = A.nextSibling; t && 1 == t.nodeType && "SPAN" == t.tagName;) if (i.isBookmarkNode(t) && "fontborder" == n) A.appendChild(t),
                        t = A.nextSibling;
                        else {
                            if (t.style.cssText == A.style.cssText && (i.moveChild(t, A), i.remove(t)), A.nextSibling === t) break;
                            t = A.nextSibling
                        }
                        if (e(A), o.ie && o.version > 8) {
                            var r = i.findParent(A,
                            function(A) {
            ...
            A.addInputRule(function(A) {
                r.each(A.getNodesByTagName("u s del font strike"),
                function(A) {
                    if ("font" == A.tagName) {
                        var e = [];
            ...
            function(A, e) {
                UE.commands[A] = {
                    execCommand: function(t, r) {
                        ...
                        if ("default" == r) {
                        	c.collapsed && (a = d.document.createTextNode("font"), c.insertNode(a).select()),
	                        d.execCommand("removeFormat", "span,a", e),
	                        a && (c.setStartBefore(a).collapse(!0), i.remove(a)),
	                        n(c, t, r),
	                        c.select();
                        } else if (c.collapsed) {
                            var g = i.findParentByTagName(c.startContainer, "span", !0);
                            a = d.document.createTextNode("font");
                            if (!g || g.children.length || g[o.ie ? "innerText": "textContent"].replace(i.fillCharReg, "").length) {
                            	c.insertNode(a), c.selectNode(a).select(), g = c.document.createElement("span");
                            	if (l[A]) {
                                    if (i.findParentByTagName(a, "a", !0)) return c.setStartBefore(a).setCursor(),
                                    void i.remove(a);
                                    d.execCommand("removeFormat", "span,a", e)
                                }
                            	g.style.cssText = e + ":" + r, a.parentNode.insertBefore(g, a);
                                if ( !o.ie || o.ie && 9 == o.version) {
                                	for (var s = g.parentNode; ! i.isBlockElm(s);){
                                		"SPAN" == s.tagName && (g.style.cssText = s.style.cssText + ";" + g.style.cssText), s = s.parentNode;
                                	}
                                }
                                o.opera ? setTimeout(function() {
                                    c.setStart(g, 0).collapse(!0),
                                    n(c, t, r),
                                    c.select()
                                }) : (c.setStart(g, 0).collapse(!0), n(c, t, r), c.select())
                            } else{ 
                            	c.insertNode(a),
	                            l[A] && (c.selectNode(a).select(), d.execCommand("removeFormat", "span,a", e, null), g = i.findParentByTagName(a, "span", !0), c.setStartBefore(a)),
	                            g && (g.style.cssText += ";" + e + ":" + r),
	                            c.collapse(!0).select();
                            }
                            i.remove(a)
                        } else {
                        	l[A] && d.queryCommandValue(A) && d.execCommand("removeFormat", "span,a", e);
                    ...
                    queryCommandValue: function(A) {
                        ...
                        if ("underline" == A || "strikethrough" == A) {
                            for (var n, r = t; r && !i.isBlockElm(r) && !i.isBody(r);) {
                                if (1 == r.nodeType && (n = i.getComputedStyle(r, e), "none" != n)) return n;
                                r = r.parentNode
                            }
                            return "none"
                        }
                        if ("fontborder" == A) {
                            for (var o, d = t; d && a.$inline[d.tagName];) {
                                if ((o = i.getComputedStyle(d, "border")) && /1px/.test(o) && /solid/.test(o)) return o;
                                d = d.parentNode
                            }
                            return ""
                        }
                        if ("FontSize" == A) {
                            var l = i.getComputedStyle(t, e),
                            d = /^([\d\.]+)(\w+)$/.exec(l);
                            return d ? Math.floor(d[1]) + d[2] : l
                        }
...
function(A, e, t) {
    ...
    r = (n(i), UE.UETable),
    o = function(A) {
        return r.getTableItemsByRange(A)
    },
    a = function(A, e) {
        return r.getDefaultValue(A, e)
    },
    d = void 0;
    e.default = {
        name: "inserttable",
            ...
            A.commands[e] = {
                execCommand: function(A, e) {
                    function r(A, e) {
                       ...
                       //Rum
                        var tableStyle = 'style="display: block !important; overflow: auto;"';
                        var tbodyStyle = ' style="display: table;width: '+window.SDE_CONFIG.SDE_TABLEWIDTH+'" ';
                       var _html = '<table class="sde-table" '+tableStyle+'><tbody'+tbodyStyle+'>' + n.join("") + "</tbody></table>";
                       if(window.SDE_CONFIG.SDE_TABLEWIDTH == 0){
                    	   _html = '<table class="sde-table"><tbody>' + n.join("") + "</tbody></table>";
                       }
                       return _html;
                    }
                    e || (e = n.extend({},
                    ...
                    /*s = c.offsetWidth,*/
                    /*king*/
                    s = window.SDE_CONFIG.SDE_TABLEWIDTH==0 ? c.offsetWidth : window.SDE_CONFIG.SDE_TABLEWIDTH,
                    /*king end*/
                    
                    u = Math.floor(s / e.numCols - 2 * g.tdPadding - g.tdBorder); ! e.tdvalign && (e.tdvalign = o.options.tdvalign),
                    o.execCommand("inserthtml", r(e, u))
                },
...
default = {
        ...
        plugin: function(A) {
            var e = this.name,
            t = r.
        default.getDialog(A, e, "scrawl/scrawl.html", "涂鸦", "", [{
                className: "edui-okbutton",
                label: "确定",
                onclick: function() {
                    t.close(!0)
...
function(A, e, t) {
    ...
    var checkboxVop = window.SDE_CONFIG ? window.SDE_CONFIG.CHECKBOXVOP:'checkbox.vop';
    var i = t(1),
    r = n(i);
    e.default = {
        name: "sdecontrolcbx",
        plugin: function(A) {
            var e = this.name,
            t = r.default.getDialog(A, e, checkboxVop, "选项列表", "width:700px;height:470px;", [{
                className: "edui-okbutton",
                label: "确定",
                onclick: function() {
                    t.close(!0)
                    ...
                    if ("BODY" != t.tagName && "HTML" != t.tagName) {
                        ...
                        if (null === i && (i = t.parentNode.getAttribute("sde-model")), null === i && "LABEL" === t.tagName && (i = t.parentNode.parentNode.getAttribute("sde-model"), t = t.parentNode), n.hide(), null !== i) {
                            ...
                            if (r && "checkbox" === r.TYPE) {
                                var o = n.formatHtml("<nobr>" + r.NAME + ' 复选框: <span onclick=$$._edit() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>');
...
function(A, e, t) {
    ...
    var dateVop = window.SDE_CONFIG ? window.SDE_CONFIG.DATEVOP:'date.vop';
    var i = t(1),
    r = n(i);
    e.default = {
        name: "sdecontroldate",
        plugin: function(A) {
            var e = this.name,
            t = r.default.getDialog(A, e, dateVop, "日期输入框", "width:700px;height:470px;", [{
                className: "edui-okbutton",
                label: "确定",
                onclick: function() {
                    t.close(!0)
...
function(A, e, t) {
    ...
    var selectVop = window.SDE_CONFIG ? window.SDE_CONFIG.SELECTVOP:'select.vop';
    var i = t(1),
    r = n(i);
    e.default = {
        ...
        plugin: function(A) {
            var e = this.name,
            t = r.default.getDialog(A, e, selectVop, "下拉框", "width:700px;height:470px;", [{
                className: "edui-okbutton",
                label: "确定",
                onclick: function() {
                    t.close(!0)
                ...
                if ("DESIGN" === window.SDE_CONFIG.MODE) {
                    ...
                    if ("BODY" != t.tagName && "HTML" != t.tagName) {
                        ...
                        if (null === i && (i = t.parentNode.getAttribute("sde-model")), n.hide(), null !== i) {
                            var r = JSON.parse(i);
                            if (r && "select" === r.TYPE) {
                                var o = n.formatHtml("<nobr>" + r.NAME + ' 下拉框: <span onclick=$$._edit() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>');
                                o ? (n.getDom("content").innerHTML = o, n.anchorEl = t, n.showAnchor(n.anchorEl)) : n.hide()
                            }
                        }
                    }
...
//    e.
//default = {
//        name: "sdecontrolqrcode",
//        plugin: function(A) {
//            var e = this.name,
//            t = r.
//        default.getDialog(A, e, "qrcode.vop", "二维码", "width:600px;height:470px;", [{
//                className: "edui-okbutton",
//                label: "确定",
//                onclick: function() {
//                	t.close(!0);
...
function(A, e, t) {
    ...
    var textVop = window.SDE_CONFIG ? window.SDE_CONFIG.TEXTVOP:'text.vop';
    var i = t(1),
    r = n(i);
    e.default = {
        name: "sdecontroltext",
        plugin: function(A) {
            var e = this.name,
            t = r.default.getDialog(A, e, textVop, "文本输入框", "width:700px;height:470px;", [{
                className: "edui-okbutton",
                label: "确定",
                onclick: function() {
                    t.close(!0)
            ...
            function(A, e) {
                    ...
                    if ("BODY" != t.tagName && "HTML" !== t.tagName) {
                        ...
                        if (null === i && (i = t.parentNode.getAttribute("sde-model")), n.hide(), null !== i) {
                            var r = JSON.parse(i);
                            //king 20170703
                            var yanshi = window.SDE_CONFIG.SDE_YANSHI;
                            if(r && yanshi && yanshi!=''){
                            	for(var key in yanshi){
	                            	if (key == r.ID) {
		                            	var o = n.formatHtml("<nobr>" + yanshi[key]+'</nobr>');
		                                o ? (n.getDom("content").innerHTML = o, n.anchorEl = t, n.showAnchor(n.anchorEl)) : n.hide()
		                            	return '';
		                            }
                            	}
                            }
                            if ("DESIGN" === window.SDE_CONFIG.MODE && r && "text" == r.TYPE) {
                        ...
                        }else if ("SPAN" == t.tagName){// 20180223 king 修订模式提示框
                            var rev = t.getAttribute("revise");
                            var ObjT = t;
                            if (null === rev && (rev = t.parentNode.getAttribute("sde-model"),ObjT = t.parentNode), n.hide(), null !== rev) {
                                var reviseauthor=t.getAttribute("reviseauthor");
                                var revisetime=t.getAttribute("revisetime");
                                var revisetype=t.getAttribute("class");
                                if(revisetype=="span-revise-edit"){
                                    revisetype="插入的";
                                }else if(revisetype=="span-revise"){
                                    revisetype="删除的";
                                }else{
                                    revisetype="";
                                }
                                var reviseTxt=$(ObjT).text()||"";
                                var o = n.formatHtml("<div style='width: 250px'>" + reviseauthor+","+revisetime+","+revisetype+"内容:"+reviseTxt +'</div>');
                                o ? (n.getDom("content").innerHTML = o, n.anchorEl = t, n.showAnchor(n.anchorEl)) : n.hide()
                                return '';
                            }
                        }
...
default = {
        ...
        plugin: function(A) {
            var e = this.name,
            t = r.
        default.getDialog(A, e, "templates.vop", "控件模板选择", "width:800px;height:470px;", [{
                className: "edui-okbutton",
                label: "确定",
                onclick: function() {
                    t.close(!0)
            ...
            A.commands[e] = {
                execCommand: function() {
                    ...
                    baidu.editor.plugins[e].CONTROL_TEMPLATES = new sdeFun().makePluginStore(),
                    t.render(),
                    t.open()
                }
            }
...
default = {
        ...
        default.registerEvent(n, "click",
            function() {
                if ("READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0) {
                    var A = d.__ue__.selection.getRange();
                    A.select(),
        ...
        default.createDriftingDiv([{
            ...
            function(e,cc) {
                ...
                var r = A.editor.__ue__.selection.getRange();
                r.select();
                var o = l(e.key);
                t = o,
                n.setAttribute("style", "font-family:" + o),
                A.editor.__ue__.execCommand("fontfamily", o)
            }),
            o = document.createElement("div");
...
default = {
        ...
        default.createDriftingDiv([{
            ...
            function(e, fk) {
        		if(fk){
                     A.editor.__ue__.execCommand("fontsize", e.value);
        		}else{
        			n.innerText = e.value,
                    i.setSelected(e.key),
                    i.root.setAttribute("style", "");
                    ...
                    var o = l(e.key);
                    t = o,
                    A.editor.__ue__.execCommand("fontsize", o)
        		}
            }),
            o = document.createElement("div");
            return o.className = "sde-icon sde-icon-down tab-content-item-panel-content-btn0-ext",
        ...
        default.registerEvent(o, "click",
            function() {
                if ("READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0) {
                    if (null !== i.root.getAttribute("style") && "" !== i.root.getAttribute("style")) return void i.root.setAttribute("style", "");
                    i.root.setAttribute("style", "display:block;");
                    i.root.onmouseover = function(A){
                    	var oldSize = sde.__ue__.queryCommandValue( 'fontsize' );
            	    	   sde.__ue__.execCommand( 'fontsize', A.target.innerText );
            	    	   i.root.onmouseout = function(A){
                    		sde.__ue__.execCommand( 'fontsize', oldSize);
                    		};
                    };
                    i.root.onclick = function(A){
                    	sde.__ue__.execCommand( 'fontsize', A.target.innerText );
                    	i.root.onmouseout = function(A){
                    		return;
                    		};
...
function(A, e, t) {
    ...
    default.getSDELang("文字颜色", "sde-toolbar-editor", "forecolor"), "tab-content-item-panel-content-btn1 ",function(e) {
        	...
        	$("div.edui-color-box").toggle();
        	sde.__ue__.onclick = function(){
        		$("div.edui-color-box").css("display","none");
        	};
        	$(document).click(function(){
        		$("div.edui-color-box").css("display","none");
        	});
        	//var oldBackColor = sde.__ue__.queryCommandValue( 'backcolor' );
    ...
    default.getSDELang("背景颜色", "sde-toolbar-editor", "backcolor"), "tab-content-item-panel-content-btn1",function() {
        	function stopPropagation(e) {			//阻止冒泡
                var ev = e || window.event;
                if (ev.stopPropagation) {
                    ev.stopPropagation();
        	...
        	//var oldForeColor = sde.__ue__.queryCommandValue( 'forecolor' );
		document.getElementsByClassName("edui-box")[0].onclick = function(ev){
								var ev = ev||window.event;
...
function(A, e, t) {
    ...
    p = function() {
        ...
        var i = u.default.getSDELang("恢复", r.default.SDE_TOOLBAR_EDITOR, "redo");
    ...
    default.registerEvent(e, "click",
        function() {
            if ("READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0) {
                var A = m.__ue__.selection.getRange();
                A.select(),
...
function(A, e, t) {
    ...
    B = function() {
        var A = document.createElement("div");
        return A.setAttribute("style", "vertical-align: top;overflow-y: auto;overflow-x: hidden;"),
        A.appendChild(E("justifyleft", r.
    default.getSDELang("向左对齐", "sde-toolbar-editor", "justifyleft"), "tab-content-item-panel-content-btn1",
        function() {
            "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && w.__ue__.execCommand("justify", "left")
        })),
        A.appendChild(E("justifycenter", r.
    default.getSDELang("居中对齐", "sde-toolbar-editor", "justifycenter"), "tab-content-item-panel-content-btn1",
        function() {
            "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && w.__ue__.execCommand("justify", "center")
        })),
        A.appendChild(E("justifyright", r.
    default.getSDELang("向右对齐", "sde-toolbar-editor", "justifyright"), "tab-content-item-panel-content-btn1 ",
        function() {
            "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && w.__ue__.execCommand("justify", "right")
        })),
        A.appendChild(E("justifyjustify", r.
    default.getSDELang("两端对齐", "sde-toolbar-editor", "justifyjustify"), "tab-content-item-panel-content-btn1 ",
        function() {
            "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && w.__ue__.execCommand("justify", "justify")
        })),
        A.appendChild(E("blockquote", r.
    default.getSDELang("引用", "sde-toolbar-editor", "blockquote"), "tab-content-item-panel-content-btn1",
        function() {
            "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && w.__ue__.execCommand("blockquote")
        })),
        A.appendChild(E("blockindent", r.
    default.getSDELang("增加缩进", "sde-toolbar-editor", "blockindent"), "tab-content-item-panel-content-btn1",
        function() {
            "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && w.__ue__.execCommand("blockindent")
        })),
        A.appendChild(E("blockoutdent", r.
    default.getSDELang("减小缩进", "sde-toolbar-editor", "blockoutdent"), "tab-content-item-panel-content-btn1",
        function() {
            "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && w.__ue__.execCommand("blockoutdent")
        })),
        A
    },
    f = function() {
...
default = {
        ...
        default.registerEvent(n, "click",
            function() {
                if ("READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0) {
                    var A = this.editor.__ue__.selection.getRange();
                    A.select(),
        ...
        default.createDriftingDiv([{
            ...
            function(e) {
                i.setSelected(e.key),
                i.root.setAttribute("style", "");
                var n = A.editor.__ue__.selection.getRange();
                n.select();
                var r = l(e.key);
                t = r,
                A.editor.__ue__.execCommand("lineheight", r)
            }),
            o = document.createElement("div");
            return o.className = "sde-icon sde-icon-down tab-content-item-panel-content-btn0-ext",
            r.
...
function(A, e, t) {
    ...
    e.default = {
        ...
        init: function() {
            ...
            e.setAttribute("style", "margin-right:0;"),
            e.className = "tab-content-item-panel-content-btn0",
            e.setAttribute("title", r.default.getSDELang("编号", "sde-toolbar-editor", "orderedlist"));
            var t = "decimal",
            n = document.createElement("div");
            n.className = "btn2-left sde-icon sde-icon-orderedlist editor-paragraphs-icon",
            r.default.registerEvent(n, "click",
            function() {
                if ("READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0) {
                    var A = this.editor.__ue__.selection.getRange();
                    A.select(),
            ...
            e.appendChild(n);
            var i = a.default.createDriftingDiv([{
                key:
                "decimal",
                value: "1., 2., 3., 4.,  ",
                style: ""
            ...
            function(e) {
                ...
                var r = l(e.key);
                t = r,
                A.editor.__ue__.execCommand("insertunorderedlist", r)
            }),
            o = document.createElement("div");
            return o.className = "sde-icon sde-icon-down tab-content-item-panel-content-btn0-ext",
            r.default.registerEvent(o, "click",
            function() {
                if ("READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0) {
                    if (null !== i.root.getAttribute("style") && "" !== i.root.getAttribute("style")) return void i.root.setAttribute("style", "");
                    i.root.setAttribute("style", "display:block;")
...
function(A, e, t) {
    ...
    e.default = {
        ...
        init: function() {
            ...
            e.setAttribute("style", "margin-right:0;"),
            e.className = "tab-content-item-panel-content-btn0",
            e.setAttribute("title", r.default.getSDELang("段后距", "sde-toolbar-editor", "rowspacingbottom"));
            var t = "5",
            n = document.createElement("div");
            ...
            function(e) {
                ...
                var r = l(e.key);
                t = r,
                A.editor.__ue__.execCommand("rowspacing", r, "bottom")
            }),
            o = document.createElement("div");
            return o.className = "sde-icon sde-icon-down tab-content-item-panel-content-btn0-ext",
            r.default.registerEvent(o, "click",
...
function(A, e, t) {
    ...
    e.default = {
        ...
        init: function() {
            ...
            e.setAttribute("style", "margin-right:0;"),
            e.className = "tab-content-item-panel-content-btn0",
            e.setAttribute("title", r.default.getSDELang("段前距", "sde-toolbar-editor", "rowspacingtop"));
            var t = "5",
            n = document.createElement("div");
            ...
            function(e) {
                ...
                var r = l(e.key);
                t = r,
                A.editor.__ue__.execCommand("rowspacing", r, "top")
            }),
            o = document.createElement("div");
            return o.className = "sde-icon sde-icon-down tab-content-item-panel-content-btn0-ext",
            r.default.registerEvent(o, "click",
...
function(A, e, t) {
    ...
    e.default = {
        ...
        init: function() {
            ...
            e.setAttribute("style", "margin-right:0;"),
            e.className = "tab-content-item-panel-content-btn0",
            e.setAttribute("title", r.default.getSDELang("编号", "sde-toolbar-editor", "unorderedlist"));
            var t = "circle",
            n = document.createElement("div");
...
function(A, e, t) {
    ...
    a = function(A, e, n, i) {
        ...
        o.innerHTML = '<img src="' + t(36)("./" + n) + '">',
        r.default.registerEvent(o, "click", i),
        o
    };
    e.default = {
        editor: null,
        init: function() {
            ...
            var e = document.createElement("div");
            e.className = "tab-content-item-panel-label",
            e.innerText = r.default.getSDELang("样式", "sde-toolbar-editor", "style"),
            A.appendChild(e);
            var t = document.createElement("div");
            return t.className = "tab-content-item-panel-content",
            t.appendChild(a(r.default.getSDELang("标准", "sde-toolbar-editor", "style01"), "tab-content-item-panel-content-box control-disabled", "style_01.png",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0
            })),
            t.appendChild(a(r.default.getSDELang("无间隔", "sde-toolbar-editor", "style02"), "tab-content-item-panel-content-box control-disabled", "style_02.png",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0
            })),
            t.appendChild(a(r.default.getSDELang("标题 1", "sde-toolbar-editor", "style03"), "tab-content-item-panel-content-box control-disabled", "style_03.png",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0
            })),
            t.appendChild(a(r.default.getSDELang("标题 2", "sde-toolbar-editor", "style04"), "tab-content-item-panel-content-box control-disabled", "style_04.png",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0
            })),
            A.appendChild(t),
...
function(A, e, t) {
    ...
    c = {
        design1: function() {
            return l(a.default.getSDELang("设计模式", r.default.SDE_TOOLBAR_FILE, "design-design"), "sde-icon-emrdesign", "#")
        }/*,
        design2: function() {
            return l(a.
        default.getSDELang("编辑模式设计器", r.
        default.SDE_TOOLBAR_FILE, "editor-design"), "sde-icon-emrdesign", "http://editor.sodiao.org/example/editor-design.html")
        },
        design3: function() {
            return l(a.
        default.getSDELang("只读模式设计器", r.
        default.SDE_TOOLBAR_FILE, "readonly-design"), "sde-icon-emrdesign", "http://editor.sodiao.org/example/readonly-design.html")
        },
        design4: function() {
            return l(a.
        default.getSDELang("按钮控制设计器", r.
        default.SDE_TOOLBAR_FILE, "btn-design"), "sde-icon-emrdesign", "http://editor.sodiao.org/example/btn-design.html")
        },
        editor20: function() {
            return l(a.
        default.getSDELang("设计模式编辑器", r.
        default.SDE_TOOLBAR_FILE, "design-editor"), "sde-icon-emrdesign", "http://editor.sodiao.org/example/design-editor.html")
        },
        editor2: function() {
            return l(a.
        default.getSDELang("编辑模式编辑器", r.
        default.SDE_TOOLBAR_FILE, "editor-editor"), "sde-icon-emrdesign", "http://editor.sodiao.org/example/editor-editor.html")
        },
        editor3: function() {
            return l(a.
        default.getSDELang("只读模式编辑器", r.
        default.SDE_TOOLBAR_FILE, "readonly-editor"), "sde-icon-emrdesign", "http://editor.sodiao.org/example/readonly-editor.html")
        },
        editor4: function() {
            return l(a.
        default.getSDELang("按钮控制编辑器", r.
        default.SDE_TOOLBAR_FILE, "btn-editor"), "sde-icon-emrdesign", "http://editor.sodiao.org/example/btn-editor.html")
        }*/
    },
    g = a.default.getSDELang("文件", r.default.SDE_TOOLBAR_FILE, r.default.SDE_TOOLBAR_FILE);
    e.default = {
        name: r.default.SDE_TOOLBAR_FILE,
        title: g,
        editor: null,
        init: function(A) {
            d = this.editor;
...
function(A, e, t) {
    ...
    s = function(A, e, t, n, i) {
        ...
        a.default.registerEvent(l, "click", i),
        d.appendChild(l),
        r.appendChild(d),
        r
    },
    u = function(A, e, t, n) {
        ...
        a.default.registerEvent(i, "click", n),
        i
    },
    m = function() {
        var A = document.createElement("div");
    ...
    p = function(A, e, t, n, i, r) {
        ...
        a.default.registerEvent(o, "click", r),
        o
    },
    w = function(A, e, t, n) {
        var i = document.createElement("div");
    ...
    E = {
        pagebreak: function() {
            var A = a.default.getSDELang("分页符", r.default.SDE_TOOLBAR_INSERT, "pagebreak");
            return s("pagebreak", A, A, "tab-content-item-panel-content-control",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && g.__ue__.execCommand("pagebreak")
            })
        },
        horizontal: function() {
        	var A = a.default.getSDELang("分割线", r.default.SDE_TOOLBAR_INSERT, "horizontal");
        ...
        spechars: function() {
            /* var A = a.default.getSDELang("字符", r.default.SDE_TOOLBAR_INSERT, "spechars");
            ...
            var e = document.createElement("div");
            e.className = "tab-content-item-panel-label",
                e.innerText = a.default.getSDELang("字符", r.default.SDE_TOOLBAR_INSERT, "spechars"),
                A.appendChild(e);

            var t = document.createElement("div");
            t.className = "tab-content-item-panel-content";
            var n = m();
            n.appendChild(w("spechars", a.default.getSDELang("字符", r.default.SDE_TOOLBAR_INSERT, "spechars"), "tab-content-item-panel-content-control",
                function () {
                    "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && g.__ue__.execCommand("spechars")
                })),
                t.appendChild(n);
            ...
            var i = m();
            i.appendChild(p("mostUsedSpechars", a.default.getSDELang("常用字符", r.default.SDE_TOOLBAR_INSERT, "mostUsedSpechars"), "tab-content-item-panel-content-control", "float:left;", "text-align: center;float:left;",
                function () {
                    "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && g.__ue__.execCommand("mostusedspechars")
                })),
                t.appendChild(i);
        ...
        link: function() {
            ...
            var e = document.createElement("div");
            e.className = "tab-content-item-panel-label",
            e.innerText = a.default.getSDELang("链接", r.default.SDE_TOOLBAR_INSERT, "links"),
            A.appendChild(e);
            var t = document.createElement("div");
            return t.className = "tab-content-item-panel-content",
            t.appendChild(u("link", a.default.getSDELang("添加链接", r.default.SDE_TOOLBAR_INSERT, "link"), "tab-content-item-panel-content-control",
            function() {
            ...
            t.appendChild(u("unlink", a.default.getSDELang("取消链接", r.default.SDE_TOOLBAR_INSERT, "unlink"), "tab-content-item-panel-content-control",
            function() {
        ...
        img: function() {
            ...
            var e = document.createElement("div");
            e.className = "tab-content-item-panel-label",
            e.innerText = a.default.getSDELang("图片", r.default.SDE_TOOLBAR_INSERT, "images"),
            A.appendChild(e);
            var t = document.createElement("div");
            t.className = "tab-content-item-panel-content";
            var n = m();
            n.appendChild(w("insertimage", a.default.getSDELang("图片", r.default.SDE_TOOLBAR_INSERT, "insertimage"), "tab-content-item-panel-content-control",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && g.__ue__.execCommand("sde-insertimage")
            })),
            t.appendChild(n);
            var i = m();
            i.appendChild(p("simpleupload", a.default.getSDELang("背景", r.default.SDE_TOOLBAR_INSERT, "simpleupload"), "tab-content-item-panel-content-control", "float:left;", "text-align: center;float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && g.__ue__.execCommand("setbackground")
            })),
            i.appendChild(p("snapscreen", a.default.getSDELang("截屏", r.default.SDE_TOOLBAR_INSERT, "snapscreen"), "tab-content-item-panel-content-control control-disabled", "float:left;", "text-align: center;float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && g.__ue__.execCommand("snapscreen")
            })),
            t.appendChild(i);
            var o = m();
            return o.appendChild(p("emotion", a.default.getSDELang("表情", r.default.SDE_TOOLBAR_INSERT, "emotion"), "tab-content-item-panel-content-control control-disabled", "float:left;", "text-align: center;float:left;",
            function() {
            ...
            o.appendChild(p("scrawl", a.default.getSDELang("涂鸦", r.default.SDE_TOOLBAR_INSERT, "scrawl"), "tab-content-item-panel-content-control ", "float:left;", "text-align: center;float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && g.__ue__.execCommand("scrawl")
            })),
            t.appendChild(o),
            A.appendChild(t),
            A
...
//        video: function() {
//            var A = a.default.getSDELang("视频", r.default.SDE_TOOLBAR_INSERT, "insertvideo");
//            return s("insertimage", A, A, "tab-content-item-panel-content-control",
//            function() {
//                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && g.__ue__.execCommand("insertvideo")
//            })
//            
//        },
        video: function() {
            ...
            var e = document.createElement("div");
            e.className = "tab-content-item-panel-label",
            e.innerText = a.default.getSDELang("视频", r.default.SDE_TOOLBAR_INSERT, "insertsdeVideo"),
            A.appendChild(e);
            var t = document.createElement("div");
            t.className = "tab-content-item-panel-content";
            var n = m();
            n.appendChild(w("insertvideo", a.default.getSDELang("视频", r.default.SDE_TOOLBAR_INSERT, "insertsdeVideo"), "tab-content-item-panel-content-control",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && g.__ue__.execCommand("sdeinsertvideo")
            })),
            t.appendChild(n);

            var i = m();
            i.appendChild(p("insertAttachment", a.default.getSDELang("附件", r.default.SDE_TOOLBAR_INSERT, "insertAttachment"), "tab-content-item-panel-content-control", "float:left;", "text-align: center;float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && g.__ue__.execCommand("sdeinsertattachment")
            })),
//            i.appendChild(p("snapscreen", a.default.getSDELang("截屏", r.default.SDE_TOOLBAR_INSERT, "snapscreen"), "tab-content-item-panel-content-control control-disabled", "float:left;", "text-align: center;float:left;",
//            function() {
//                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && g.__ue__.execCommand("snapscreen")
...
//            t.appendChild(o),
        ...
        /*  background:function(){
        	var A = a.default.getSDELang("背景", r.default.SDE_TOOLBAR_INSERT, "background");
            return s("setbackground", A, A, "tab-content-item-panel-content-control",
                function() {
                    "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && g.__ue__.execCommand("setbackground")
                })
        }
         ,*/
        map: function() {
            var A = a.default.getSDELang("地图", r.default.SDE_TOOLBAR_INSERT, "map");
        ...
        code: function() {
            var A = a.default.getSDELang("代码", r.default.SDE_TOOLBAR_INSERT, "insertcode");
        ...
        table: function() {
            ...
            var e = document.createElement("div");
            e.className = "tab-content-item-panel-label";
            var t = a.default.getSDELang("表格", r.default.SDE_TOOLBAR_INSERT, "table");
            e.innerText = t,
            A.appendChild(e);
            var n = document.createElement("div");
            return n.className = "tab-content-item-panel-content",
            c.default.editor = g,
            n.appendChild(c.default.init(t)),
            A.appendChild(n),
            A
        },
        formula: function() {
            var A = a.default.getSDELang("公式", r.default.SDE_TOOLBAR_INSERT, "blockformula");
            return s("blockformula", A, A, "tab-content-item-panel-content-control",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && g.__ue__.execCommand("blockformula")
            })
        },
        template: function() {
            var A = a.default.getSDELang("模板", r.default.SDE_TOOLBAR_INSERT, "blocktemplate");
            return s("blocktemplate", A, A, "tab-content-item-panel-content-control",
                function() {
                    "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && g.__ue__.execCommand("texttemp")
                })
        }/*,
        comment: function() {
            var A = a.default.getSDELang("批注", r.default.SDE_TOOLBAR_INSERT, "blockcomment");
        ...
        ,
        button: function() {
            var A = a.default.getSDELang("按钮", r.default.SDE_TOOLBAR_INSERT, "button");
            return s("button", A, A, "tab-content-item-panel-content-control",
            function() {
            	var sdefun = new sdeFun();
            	var param = {};
            	param.funcName = 'window.parent.getDialog()';
            	param.title = '插入dialog';
            	sdefun.insertButton(param);
            	var param = {
            			label:'按钮',
            			url:window.SDE_CONFIG.HOME_URL_DIALOGS +'button/button.vop' // 这是一个返回dialog所呈现页面的SpringMVC请求。
            		}
    ...
    e.default = {
        name: r.default.SDE_TOOLBAR_INSERT,
        title: a.default.getSDELang("插入", r.default.SDE_TOOLBAR_INSERT, r.default.SDE_TOOLBAR_INSERT),
        editor: null,
        init: function(A) {
            g = this.editor;
            var e = document.createElement("div");
            ...
            n = A.length; t < n; t++) {
                ...
                r = E[i],
                void 0 !== r && e.appendChild(r(this.editor))
                // void 0 !== r && console.log(r(this.editor));
            }
            // console.log(123)
            return e
        }
...
function(A, e, t) {
    ...
    g = {
        sdetemplate: function() {
            var A = a.default.getSDELang("控件库", r.default.SDE_TOOLBAR_RECORDS, "sdetemplate");
        ...
        sdecontrols: function() {
            ...
            var e = document.createElement("div");
            e.className = "tab-content-item-panel-label",
            e.innerText = a.default.getSDELang("新增控件", r.default.SDE_TOOLBAR_RECORDS, "controls"),
            A.appendChild(e);
            var t = document.createElement("div");
            t.className = "tab-content-item-panel-content";
            var tt1 = c("sdecontroltext", a.default.getSDELang("单行文本", r.default.SDE_TOOLBAR_RECORDS, "sdecontroltext"), "tab-content-item-panel-content-control sde-ctrl", "float:left;", "text-align: center;float:left;margin-left:3px;",
	                function() {
	                    "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && d.__ue__.execCommand("sdecontroltext")
	                });
            var tt2 = c("sdecontroldate", a.default.getSDELang("日期输入", r.default.SDE_TOOLBAR_RECORDS, "sdecontroldate"), "tab-content-item-panel-content-control sde-ctrl", "float:left;", "text-align: center;float:left;margin-left:3px;",
		            function() {
		                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && d.__ue__.execCommand("sdecontroldate")
		            });

            var tt3 = c("sdecontrolcbx", a.default.getSDELang("二维码", r.default.SDE_TOOLBAR_RECORDS, "sdecontrolqrcode"), "tab-content-item-panel-content-control sde-ctrl", "float:left;", "text-align: center;float:left;margin-left:3px;",
		            function() {
		                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && d.__ue__.execCommand("sdecontrolqrcode");

		            });

            var tt4 = c("sdecontrolselect", a.default.getSDELang("下拉列表", r.default.SDE_TOOLBAR_RECORDS, "sdecontrolselect"), "tab-content-item-panel-content-control sde-ctrl", "float:left;", "text-align: center;float:left;margin-left:3px;",
		            function() {
		                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && d.__ue__.execCommand("sdecontrolselect")
		            });
            tt4.style.clear = "both";
            var tt5 = c("sdecontrolcbx", a.default.getSDELang("选项列表  ", r.default.SDE_TOOLBAR_RECORDS, "sdecontrolcbx"), "tab-content-item-panel-content-control sde-ctrl", "float:left;", "text-align: center;float:left;margin-left:3px;",
		            function() {
		                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && d.__ue__.execCommand("sdecontrolcbx")
		            });

            var tt6 = c("sdecontrolcbx", a.default.getSDELang("条形码", r.default.SDE_TOOLBAR_RECORDS, "sdecontrolbarcode"), "tab-content-item-panel-content-control sde-ctrl", "float:left;", "text-align: center;float:left;margin-left:3px;",
		            function() {
		                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && d.__ue__.execCommand("sdecontrolbarcode")
		            });
            t.appendChild(tt1);
            t.appendChild(tt2);
            t.appendChild(tt3);
    ...
    e.default = {
        name: r.default.SDE_TOOLBAR_RECORDS,
        title: a.default.getSDELang("控件", r.default.SDE_TOOLBAR_RECORDS, r.default.SDE_TOOLBAR_RECORDS),
        editor: null,
        init: function(A) {
            d = this.editor;
            var e = document.createElement("div");
...
function(A, e, t) {
    ...
    u = {
        table: function() {
            ...
            var e = document.createElement("div");
            e.className = "tab-content-item-panel-label",
            e.innerText = a.default.getSDELang("表格", r.default.SDE_TOOLBAR_TABLES, "tables"),
            A.appendChild(e);
            var t = document.createElement("div");
            t.className = "tab-content-item-panel-content",
            l.default.editor = c,
            t.appendChild(l.default.init(a.default.getSDELang("插入表格", r.default.SDE_TOOLBAR_TABLES, "inserttables"))),
            t.appendChild(g("deletetable", a.default.getSDELang("删除表格", r.default.SDE_TOOLBAR_TABLES, "deletetable"), "tab-content-item-panel-content-control", "width: 48px;height: 32px;", "text-align: center;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("deletetable")
            }));
            var n = document.createElement("div");
            n.style.float = "left",
            n.appendChild(s("insertrow", a.default.getSDELang("插入行", r.default.SDE_TOOLBAR_TABLES, "insertrow"), "tab-content-item-panel-content-btn1 ", "float:left;", "float:left;",
            function() {
                 c.__ue__.execCommand("insertrow")
            })),
            n.appendChild(s("insertcol", a.default.getSDELang("插入列", r.default.SDE_TOOLBAR_TABLES, "insertcol"), "tab-content-item-panel-content-btn1 ", "float:left;", "float:left;",
            function() {
                c.__ue__.execCommand("insertcol")
            }));
            var i = document.createElement("div");
            return i.style.clear = "both",
            n.appendChild(i),
            n.appendChild(s("deleterow", a.default.getSDELang("删除行", r.default.SDE_TOOLBAR_TABLES, "deleterow"), "tab-content-item-panel-content-btn1 ", "float:left;", "float:left;",
            function() {
                 c.__ue__.execCommand("deleterow")
            })),
            n.appendChild(s("deletecol", a.default.getSDELang("删除列", r.default.SDE_TOOLBAR_TABLES, "deletecol"), "tab-content-item-panel-content-btn1 ", "float:left;", "float:left;",
            function() {
                c.__ue__.execCommand("deletecol")
            })),
            t.appendChild(n),
            A.appendChild(t),
            A
        ...
        blockmergecells: function() {
            ...
            var e = document.createElement("div");
            e.className = "tab-content-item-panel-label",
            e.innerText = a.default.getSDELang("合并单元格", r.default.SDE_TOOLBAR_TABLES, "merge"),
            A.appendChild(e);
            var t = document.createElement("div");
            t.className = "tab-content-item-panel-content",
            t.appendChild(s("mergecells", a.default.getSDELang("合并单元格", r.default.SDE_TOOLBAR_TABLES, "mergecells"), "tab-content-item-panel-content-btn1 ", "float:left;", "float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("mergecells")
            })),
            t.appendChild(s("mergedown", a.default.getSDELang("向下合并单元格", r.default.SDE_TOOLBAR_TABLES, "mergedown"), "tab-content-item-panel-content-btn1 ", "float:left;", "float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("mergedown")
            })),
            t.appendChild(s("mergeright", a.default.getSDELang("向右合并单元格", r.default.SDE_TOOLBAR_TABLES, "mergeright"), "tab-content-item-panel-content-btn1 ", "float:left;", "float:left;",
            function() {
            ...
            t.appendChild(n),
            t.appendChild(s("splittocells", a.default.getSDELang("拆分单元格", r.default.SDE_TOOLBAR_TABLES, "splittocells"), "tab-content-item-panel-content-btn1 ", "float:left;", "float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("splittocells")
            })),
            t.appendChild(s("splittocols", a.default.getSDELang("单元格拆分成列", r.default.SDE_TOOLBAR_TABLES, "splittocols"), "tab-content-item-panel-content-btn1 ", "float:left;", "float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("splittocols")
            })),
            t.appendChild(s("splittorows", a.default.getSDELang("单元格拆分成行", r.default.SDE_TOOLBAR_TABLES, "splittorows"), "tab-content-item-panel-content-btn1 ", "float:left;", "float:left;",
            function() {
        ...
        alignmergecells: function() {
            ...
            var e = document.createElement("div");
            e.className = "tab-content-item-panel-label",
            e.innerText = a.default.getSDELang("对齐方向", r.default.SDE_TOOLBAR_TABLES, "alignmerge"),
            A.appendChild(e);
            var t = document.createElement("div");
            t.className = "tab-content-item-panel-content",
            t.appendChild(s("valign-top", a.default.getSDELang("顶端对齐", r.default.SDE_TOOLBAR_TABLES, "valign-top"), "tab-content-item-panel-content-btn1 ", "float:left;", "float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("cellvalign", "top")
            })),
            t.appendChild(s("valign-middle", a.default.getSDELang("垂直居中", r.default.SDE_TOOLBAR_TABLES, "valign-middle"), "tab-content-item-panel-content-btn1 ", "float:left;", "float:left;",
            function() {
            	"READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("cellvalign", "middle")
            })),
            t.appendChild(s("valign-bottom", a.default.getSDELang("底端对齐", r.default.SDE_TOOLBAR_TABLES, "valign-bottom"), "tab-content-item-panel-content-btn1 ", "float:left;", "float:left;",
            function() {
            ...
            return n.style.clear = "both",
            t.appendChild(n),
            t.appendChild(s("align-left", a.default.getSDELang("左对齐", r.default.SDE_TOOLBAR_TABLES, "align-left"), "tab-content-item-panel-content-btn1 ", "float:left;", "float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("cellalign", "left")
            })),
            t.appendChild(s("align-center", a.default.getSDELang("居中", r.default.SDE_TOOLBAR_TABLES, "align-center"), "tab-content-item-panel-content-btn1 ", "float:left;", "float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("cellalign", "center")
            })),
            t.appendChild(s("align-right", a.default.getSDELang("右对齐", r.default.SDE_TOOLBAR_TABLES, "align-right"), "tab-content-item-panel-content-btn1 ", "float:left;", "float:left;",
            function() {
        ...
        alignmergecells1: function() {
            var A = document.createElement("div");
            A.className = "tab-content-item-panel";
            var e = document.createElement("div");
            e.className = "tab-content-item-panel-label",
            e.innerText = a.default.getSDELang("边框线", r.default.SDE_TOOLBAR_TABLES, "alignmerge"),
            A.appendChild(e);
            var t = document.createElement("div");
            t.className = "tab-content-item-panel-content tab-content-item-panel-width";
            t.appendChild(s("border-top", a.default.getSDELang("上边框", r.default.SDE_TOOLBAR_TABLES, "border-top"), "tab-content-item-panel-content-btn1", "float:left;", "float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("border", "sde-tableborder-top");                
            }));
            t.appendChild(s("border-left", a.default.getSDELang("左边框", r.default.SDE_TOOLBAR_TABLES, "border-left"), "tab-content-item-panel-content-btn1", "float:left;", "float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("border", "sde-tableborder-left");
            }));
            t.appendChild(s("border-bottom", a.default.getSDELang("下边框", r.default.SDE_TOOLBAR_TABLES, "border-bottom"), "tab-content-item-panel-content-btn1", "float:left;", "float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("border", "sde-tableborder-bottom");
            }));
            t.appendChild(s("border-right", a.default.getSDELang("右边框", r.default.SDE_TOOLBAR_TABLES, "border-right"), "tab-content-item-panel-content-btn1", "float:left;", "float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("border", "sde-tableborder-right");
            }));
            /*t.appendChild(s("border-y", a.default.getSDELang("斜下边框", r.default.SDE_TOOLBAR_TABLES, "border-y"), "tab-content-item-panel-content-btn1", "float:left;", "float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("border", "sde-tableborder-y");
            }));*/
            /*var n = document.createElement("div");
            t.appendChild(s("border-x", a.default.getSDELang("斜上边框", r.default.SDE_TOOLBAR_TABLES, "border-x"), "tab-content-item-panel-content-btn1", "float:left;", "float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("border", "sde-tableborder-x");
            }));
            var n = document.createElement("div");
            n.style.clear = "both";
            t.appendChild(n);*/
            
            t.appendChild(s("border-all", a.default.getSDELang("全边框", r.default.SDE_TOOLBAR_TABLES, "border-all"), "tab-content-item-panel-content-btn1", "float:left;", "float:left;",
            function() {
            "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("border", "sde-tableborder-all");
             }));
            t.appendChild(s("border-out", a.default.getSDELang("外边框", r.default.SDE_TOOLBAR_TABLES, "border-out"), "tab-content-item-panel-content-btn1", "float:left;", "float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("border", "sde-tableborder-out");
            }));
            /*t.appendChild(s("border-center", a.default.getSDELang("中边框", r.default.SDE_TOOLBAR_TABLES, "border-center"), "tab-content-item-panel-content-btn1", "float:left;", "float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("border", "sde-tableborder-center");
            }));
            t.appendChild(s("border-h", a.default.getSDELang("横边框", r.default.SDE_TOOLBAR_TABLES, "border-h"), "tab-content-item-panel-content-btn1", "float:left;", "float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("border", "sde-tableborder-h");
            }));
            t.appendChild(s("border-s", a.default.getSDELang("竖边框", r.default.SDE_TOOLBAR_TABLES, "border-s"), "tab-content-item-panel-content-btn1", "float:left;", "float:left;",
            function() {
            	"READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("border", "sde-tableborder-s");
            }));*/
            t.appendChild(s("border-no", a.default.getSDELang("无边框", r.default.SDE_TOOLBAR_TABLES, "border-no"), "tab-content-item-panel-content-btn1", "float:left;", "float:left;",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && c.__ue__.execCommand("border", "sde-tableborder-no");
            }));
            var n = document.createElement("div");
    ...
    e.default = {
        name: r.default.SDE_TOOLBAR_TABLES,
        title: a.default.getSDELang("表格", r.default.SDE_TOOLBAR_TABLES, r.default.SDE_TOOLBAR_TABLES),
        editor: null,
        init: function(A) {
            c = this.editor;
            var e = document.createElement("div");
...
function(A, e, t) {
    ...
    c = {
        /*drafts: function() {
            var A = a.default.getSDELang("草稿箱", r.default.SDE_TOOLBAR_TOOLS, "drafts");
        ...
        print: function() {
            var A = a.default.getSDELang("打印", r.default.SDE_TOOLBAR_TOOLS, "print");
        ...
        searchreplace: function() {
            return l("searchreplace", a.default.getSDELang("查找替换", r.default.SDE_TOOLBAR_TOOLS, "search"), a.default.getSDELang("查找替换", r.default.SDE_TOOLBAR_TOOLS, "searchreplace"), "tab-content-item-panel-content-control",
            function() {
                "READONLY" !== window.SDE_CONFIG.MODE && this.className.indexOf("control-disabled") < 0 && d.__ue__.execCommand("opensearchreplace")
            })
        },
        wordcount: function() {
            var A = a.default.getSDELang("字数统计", r.default.SDE_TOOLBAR_TOOLS, "wordcount");
    ...
    e.default = {
        name: r.default.SDE_TOOLBAR_TOOLS,
        title: a.default.getSDELang("工具", r.default.SDE_TOOLBAR_TOOLS, r.default.SDE_TOOLBAR_TOOLS),
        editor: null,
        init: function(A) {
            d = this.editor;
            var e = document.createElement("div");
...
function(A, e, t) {
    ...
    e.default = {
        name: r.default.SDE_TOOLBAR_VIEWS,
        title: a.default.getSDELang("视图", r.default.SDE_TOOLBAR_VIEWS, r.default.SDE_TOOLBAR_VIEWS),
        editor: null,
        init: function(A) {
...
function(A, e, t) {
    ...
    /*p = function(A, e, t) {
        var n, i = window.UE.dom.domUtils, r = i.getElementsByTagName(A, A.tagName.toLowerCase());
        for (var o = 0; n = r[o++];)
         if (n.parentNode && !i.isBookmarkNode(n))
            if ("span" != n.tagName.toLowerCase() || n.getAttribute("sde-model")) 
                i.isSameElement(A, n) && i.remove(n, !0),///Rum   不知道干嘛用的，直接注射掉，有bug在查
                n.style.cssText = n.style.cssText + ";" + A.style.cssText,
                i.remove(A, true);
            else {
                if (A === n.parentNode && (i.trimWhiteTextNode(A), 1 == A.childNodes.length)) {
                    /!*2017-8-10 author: Rum *!/
                    //n.style.cssText = n.style.cssText + ";" + A.style.cssText;
                    //i.remove(A, true);
                    /!*end*!/
        ...
        p = function(A, e, t) {         //Nothing,svn恢复源代码，段落不能全选问题
            for (var n, i = window.UE.dom.domUtils,
                     r = i.getElementsByTagName(A, A.tagName.toLowerCase()), o = 0; n = r[o++];) if (n.parentNode && !i.isBookmarkNode(n))                      if ("span" != n.tagName.toLowerCase() || n.getAttribute("sde-model"))
                         i.isSameElement(A, n) && i.remove(n, !0),
                         n.style.cssText = n.style.cssText + ";" + A.style.cssText;
            else {
                if (A === n.parentNode && (i.trimWhiteTextNode(A), 1 == A.childNodes.length)) {
                    A.style.cssText = n.style.cssText + ";" + A.style.cssText,
    ...
    window.SDE = function(A) {
        ...
        if(A.datasource) window.SDE_CONFIG.DATASOURCE = A.datasource; //数据源配置
        if(A.setpmargin) window.SDE_CONFIG.SETPMARGIN = A.setpmargin; //设置p标签的样式
        if(A.sde_toolbar ){
            window.SDE_TOOLBAR = A.sde_toolbar;
            a.default.defaultOptions.toolbars = A.sde_toolbar;
        }
        var sdeDefaultOpt = a.default.defaultOptions;
        A = l.default.deepCopy(sdeDefaultOpt, A);
        if(A.iconmarks) window.SDE_CONFIG.ICONMARKS = A.iconmarks; //控件图标标识，默人没有，1表示启用，
        if(A.sde_font_size) window.SDE_CONFIG.SDE_FONT_SIZE = A.sde_font_size;
        if(A.sde_line_height) window.SDE_CONFIG.SDE_LINE_HEIGHT = A.sde_line_height;	
        if(A.view_padding) window.SDE_CONFIG.VIEW_PADDING = A.view_padding;	
        if(A.body_font_family) window.SDE_CONFIG.BODY_FONT_FAMILY = A.body_font_family;	
        if(A.body_class) window.SDE_CONFIG.BODY_CLASS = A.body_class;
        if(A.mip_mrhp) window.SDE_CONFIG.MIP_MRHP = A.mip_mrhp;                         //mip,病案首页的标识fu
        if(A.sde_free_meun) window.SDE_CONFIG.SDE_FREE_MEUN = A.sde_free_meun;          //是否禁用默认的右键内容，默认不禁止，1表示禁止，
        if(A.dis_draggable) window.SDE_CONFIG.DIS_DRAGGABLE = A.dis_draggable;          //是否禁止文本拖拽，默认不禁止，1表示禁止，
        if(A.is_sde_bg) window.SDE_CONFIG.IS_SDE_BG = A.is_sde_bg;                      //控件背景色,0表示沒有背景色，1表示有背景色

        //king
        var e = document.getElementById(A.id);
        var _content;
        if(A._content != undefined){
       		var header='<script id="myEditor" type="text/plain" style="width:'+window.SDE_CONFIG.SDE_EDITORWIDTH+';height:1000px;">';
        	var footer='</script>';
        	_content=header + A._content + footer;
        }else{
        	_content=e.outerHTML;
        }
        ...
        if ("" !== A.mode && (window.SDE_CONFIG.MODE = A.mode), A.control_templates && A.control_templates.length > 0){ 
        	for (var t = 0,  n = A.control_templates.length; t < n; t++) {
        		window.SDE_CONFIG.CONTROL_TEMPLATES.push(A.control_templates[t]);
        	}
        }
        if(window.SDE_CONFIG.MODE && "READONLY" ===window.SDE_CONFIG.MODE){
        ...
        i.appendChild(u(_content, A.footer)),
        ...
        o.__ue__.ready(function() {
            ...
            e2.setAttribute("src", window.SDE_CONFIG.HOME_URL_DIALOGS+'js/jquery-3.2.1.js' + "?_=" + (new Date).getTime()),
            o.__ue__.document.head.appendChild(e2);
            ...
            e2.onload = function(){
                ...
                window.ISDEBUGGER ? e.setAttribute("src", window.SDE_CONFIG.EDITOR_URL + "?_=" + (new Date).getTime()) : e.setAttribute("src", window.SDE_CONFIG.EDITOR_URL),
                    e.setAttribute("id", "EDITOR_URL"),
                    o.__ue__.window.__ready__ = function() {
                        //king 20171227 sdes变量继承sde.editor中的SDE属性.
                        window.SDE.prototype.sdes = o.__ue__.window.sde;
                        //king 20180125 控件分类
                        var $myEditor = $("#myEditor");
                        $myEditor.addClass("sde-tree");
                        if(treeObj && window.SDE_CONFIG.SDETREE=="1"){
                            new sdeFun().initSDETree();
                        }
                        null !== w && w.call(o);
                    },
                    o.__ue__.document.head.appendChild(e);
            	var e3 = document.createElement("script");
                e3.setAttribute("src", window.SDE_CONFIG.HOME_URL_DIALOGS+'js/ryExpand.js' + "?_=" + (new Date).getTime()),
                    e3.setAttribute("id", "RYEXPAND"),
                o.__ue__.document.head.appendChild(e3);
                var e4 = document.createElement("script");
                e4.setAttribute("src", window.SDE_CONFIG.HOME_URL + 'dialogs/barcode/JsBarcode.all.min.js' + "?_=" + (new Date).getTime()),
                o.__ue__.document.head.appendChild(e4);
                /*
                var e6 = document.createElement("script");
                e6.setAttribute("src", window.SDE_CONFIG.HOME_URL + 'dialogs/vue/vue.min.js' + "?_=" + (new Date).getTime()),
                    o.__ue__.document.head.appendChild(e6);
                $(o.__ue__.document.body).wrapInner("<div id='vueMount'></div>");*/ //vue挂载div上  Nothing 2017-12-12
                ...
                $(document).on('blur', 'span[class~="checkNull"]', function() {
            		...
            		if (str != '') {
            			...
            			var sibL = $(el).siblings(".sde-right")[0];
            	...
            	var COLORS = (
            			...
            			var html = '<div  class="edui-color-box" style="z-index:1009;left:534px;margin-top:-20px;visibility:visible;position:absolute;border:1px solid #ddd;display:none;" >' + '<table class="edui-box edui-default" style="border-collapse: collapse;" cellspacing="0" cellpadding="0"><tbody class="edui-default">' +
            				'<tr  style="border-bottom: 1px solid #ddd;font-size: 13px;line-height: 25px;color:#39C;padding-top: 2px" class="edui-default"><td  colspan="10" class="edui-default" >'+"主题颜色"+'</td> </tr>'+
            	...
            	if($("#ueditor_0").contents().find('div.videobox')){
                     ...
                     '<video class="video-player" class="video-js vjs-default-skin" controls preload="none" width="640" height="264" style="background:black" data-setup="{}">'+
                ...
                $("div.sde").append("<div class='shadeDiv' align='center' style='position: fixed;cursor:pointer; z-index: 1000; display:none; background-color:black; background: rgba(0, 0, 0, 0.5); width:100%; height:100%;top:0px; border:1px solid #222;'>"+
                    "<img class='enlargeImg' style='height:80%;margin: 80px auto;opacity:1;filter:alpha(opacity=100);'/>"+"</div>");
                $(".shadeDiv").bind("click",function(){
            ...
            if (A.iframe_css_src) {
				if ("string" == typeof A.iframe_css_src && "" !== A.iframe_css_src) {
					var d = document.createElement("link");
					d.setAttribute("type", "text/css"),
					d.setAttribute("href", A.iframe_css_src),
					o.__ue__.document.head.appendChild(d)
				} else if (l.default.isArray(A.iframe_css_src) && A.iframe_css_src.length > 0){
					for (var c = 0, g = A.iframe_css_src.length; c < g; c++) {
            ...
            if (A.iframe_js_src){
				if ("" !== A.iframe_js_src && "string" == typeof A.iframe_js_src ) {
					var n = document.createElement("script");
					n.setAttribute("src", A.iframe_js_src),
					o.__ue__.document.head.appendChild(n)
				} else if (l.default.isArray(A.iframe_js_src) && A.iframe_js_src.length > 0) {
					for (var i = 0, r = A.iframe_js_src.length; i < r; i++) {
						var a = document.createElement("script");
			...
			//king 禁止文本拖拽，默认不禁止，1表示禁止，
			if(window.SDE_CONFIG.DIS_DRAGGABLE == '1'){
                var doc = o.__ue__.document;
            ...
            null !== E && (o.__ue__.document.body.innerHTML = E),
            /*o.__ue__.execCommand("fontfamily", "arial, helvetica, sans-serif"),
            o.__ue__.execCommand("fontsize", "14px"),*/
            o.__ue__.addListener("keydown",function(A, e) {
            	//keydown事件发生在键盘的键被按下的时候，接下来触发keypress事件。 keyup 事件在按键被释放的时候触发
                var t = e.keyCode || e.which;
                // 13=enter键
               if (13 === t) {
                	var n = e.target.parentNode;
                	var sde_model = n.getAttribute("sde-model"),
                   json_model = JSON.parse(sde_model);
                    if (null !== sde_model && !(json_model.TYPE=="text"||json_model.TYPE=="checkbox")){
                    	return e.preventDefault ? e.preventDefault() : e.returnValue = !1,void e.stopPropagation()
                    }
                }
                //添加删除线样式
                function addReviseCss(other_range,selection,edit) {
            		var oFragment = other_range.extractContents();
                    var $span = $("<span class='span-revise' revise='revise'  id='revise' contenteditable='false'></span>");
                    if(edit){
                        $span = $("<span class='span-revise-edit' revise='revise' id='revise-edit'>&zwj;</span>");
                    }
                    $span.attr("revisetime",new Date().format("yyyy-MM-dd hh:mm:ss"));
                    $span.attr("reviseauthor",window.SDE_CONFIG.PWP_USER_ID||"");
                    var span = $span[0];

                    span.appendChild(oFragment);
        			other_range.insertNode(span);
            	}
                ...
                //修订模式，REVISE模式下删除线  trace 4321
                if (window.SDE_CONFIG.MODE == "REVISE") {
                	// 浏览器的range对象
                	var ie_range, other_range, selection, getText ;

                	try {
                		selection = this.selection.getNative();
                		other_range = selection.getRangeAt(0);
                		getText = this.selection.getText();
                	} catch (e) {
                	...
                	if (other_range) {
                		...
                		// console.log("你按的是del键");
                		if (e.keyCode == 8) {
                			// 在红色删除线区，无操作
                			if (parentNode.hasClass("span-revise-edit")) {
                				return;
                			}
                			// 阻止默认事件
                			blockDefaults(e);
                			if (!getText) {// 有选中文字；
                				selection.modify("extend", "backward", "character");// 光标向后选中一格
                				var selectionNew = this.selection.getNative();
                				var rangeNew = selectionNew.getRangeAt(0);
                				addReviseCss(rangeNew, selectionNew);
                				// 让光标显示出来
                				selection.modify("move", "backward", "character");// 光标向后移动一格
                				selection.modify("move", "forward", "character");// 光标向前移动一格
                				return;
                			} else if (getText && selection.type == "Range") {// 没有有选中文字；
                				addReviseCss(other_range, selection);
                				selection.modify("move", "backward", "character");
                				// return ;//这里不能有return,有return的效果是加上删除线后文字部分会是选中状态
                			}
                		}else if (e.keyCode < 36 || e.keyCode > 40) {// console.log("上下左右键，不做操作");
                			// console.log("在删除区，禁用所有键");
                			if (parentNode.hasClass("span-revise")) {
                				blockDefaults(e);
                				return;
                			}
                			// console.log("在非红色编辑区，禁用shift、ctrl、alt、空格、Windows键");
                			if (!parentNode.hasClass("span-revise-edit") && (e.shiftKey || e.ctrlKey || e.altKey || e.keyCode == 91 || e.keyCode == 32)) {
                				blockDefaults(e);
                				return;
                			}
                			// console.log("在非红色编辑区，插入红色编辑节点");
                			if (!parentNode.hasClass("span-revise-edit") && focusNode.nodeType == 3) {
                				if (getText) {
                					addReviseCss(other_range, selection);
                					selection.modify("move", "forward", "character");// 修复无法输入中文
                					blockDefaults(e);
                					return;
                				} else {
                					addReviseCss(other_range, selection,"edit");
                					selection.modify("move", "forward", "character");// 修复无法输入中文
                				}
                			}
                		}
                		...
                		//TODO,这里IE下不知是否可行！
                		ie_range.pasteHTML("<span class='span-revise-edit'>"+ ie_range.htmlText + "&nbsp;</span>");
            ...
            o.__ue__.addListener("keyup",function(A, e) {
            	//keydown事件发生在键盘的键被按下的时候，接下来触发keypress事件。 keyup 事件在按键被释放的时候触发
                var t = e.keyCode || e.which;
                // 8=backSpace键
                //8 === t&& console.log("暂未实现删除时检验控件完整性功能！")

            }),
             o.__ue__.addListener("contentChange",function(){
                 //编辑器内容发生改变时会修改该值，0表示沒有改变
                window.SDE_CONFIG.IS_CONTENTCHAGNE = "true";
                //console.log('内容改变');
            });
        });
        var d = document.getElementsByClassName("sde-header")[0];
        if (r.default.editor = o, window.SDE.Plugins && window.SDE.Plugins.length > 0){
        	for (var c = 0, B = window.SDE.Plugins.length; c < B; c++){
        		r.default.ext_renders.push(window.SDE.Plugins[c]);
        	}
        }
        if (window.SDE.Plugins_left && window.SDE.Plugins_left.length > 0){
            for (var cc = 0, BB = window.SDE.Plugins_left.length; cc < BB; cc++){
                r.default.ext_renders_left.push(window.SDE.Plugins_left[cc]);
            }
        }
        d.appendChild(r.default.init(A.toolbars))//trace 890
    },
    /**
     * king sdejiekou 接口
     */
    window.SDE.prototype = {
		 ...
		 */
	    html: function(A) {
            $(sde.querySelectorAll(".sde-select-root")).remove();
		 ...
		 * No6.1. 为所有的控件内容添加下划线
		 */
	    setControlUnderline: function(A) {
	    	this.sdes.setControlUnderline(A);
	    },
	    /**
		 * No6.2. 检查是否存在空值
		 */
	    checkNull: function(A) {
	    	return this.sdes.checkNull(A);
	    },
        /**
         * No6.3. 检查是否存在小红点
         */
        checkRedPoint : function(A) {
            return this.sdes.checkRedPoint(A);
        },
        /**
         * No6.3.1. 去除所有小红点
         */
        cancelRedPoint : function(A) {
            return this.sdes.cancelRedPoint(A);
        },
		/**
		 * No6.3.2. 必填项校验
		 */
        checkRequire : function(A) {
	    	return this.sdes.checkRequire(A);
		},
		/**
		 * No6.4. 设置下拉框的框框
		 */
		setMRHPSelect : function(param) {
            return this.sdes.setMRHPSelect(A);
		},
		/**
		 * No6.5. 修改sde-value的属性为：plaintext-only
		 */
		setPlaintextOnly : function(param) {
			return this.sdes.setPlaintextOnly(param);
		},
	    /**
		 * No7.暂未实现
		 */
	    checkControl: function() {
	        return this.sdes.checkControl()
	    },
        /**
         * No7.1.设置条形码
         */
        setBarcode : function(param){
	        return this.sdes.setBarcode(param);
        },
	    /**
		 * --------------------------------------------------------------------------------------------------
		 *
		 * No8. 追加编辑器内容
		 */
	    setContent: function(texts) {
	        this.__ue__.setContent(texts, true);
	    },
	    /**
		 * --------------------------------------------------------------------------------------------------
		 *
	    ...
	    inserthtml: function(text) {
	        sde.setExecCommands("inserthtml", text);
	    },
	    /**
		 * No9. 设置编辑器为： 设计模式
		 */
	    setDesign: function() {
	        this.__ue__.setEnabled();
	        this.setMode("DESIGN");
	    },
	    /**
		 * No10. 设置编辑器为： 编辑模式
		 */
	    setEditor: function() {
            return this.setMode("EDITOR");
	        //this.__ue__.setDisabled();
	    },
	    /**
		 * No10.1. 设置编辑器为： 修订模式
		 */
	    setRevise: function() {
            return this.setMode("REVISE");
	    },
	    /**
		 * No11. 设置编辑器为： 只读模式
		 */
	    setReadonly: function() {
            return this.setMode("READONLY");
	        //this.__ue__.setDisabled();
	    },

	    /**
		 * No12. 根据code,设置编辑器为：禁用模式 param参数 code是工具条中Ueditor的值
		 *
		 */
	    setDisabled: function(code) {
            return this.__ue__.setDisabled(code);
	    },
	    /**
		 * No13. 设置编辑器为：启用模式
		 *
		 */
	    setEnabled: function() {
            return this.__ue__.setEnabled();
	    },
	    /**
		 * No14. setExecCommand param参数 code是Ueditor的命令
		 */
	    setExecCommand: function(code) {
            return this.__ue__.execCommand(code);
	    },
	    /**
		 * No15. setExecCommand param参数 code是Ueditor的命令
		 */
	    setExecCommands: function(code, html) {
            return this.__ue__.execCommand(code, html);
	    },
	    /**
		 * No15.1. 是Ueditor的命令
		 */
	    execCommand: function(cmd, val) {
	    	return this.__ue__.execCommand(cmd, val);
	    },
        /**
         * No15.2. 设置编辑器的宽度：width（A4:210mm，A5:148mm，A3：297mm）
         */
        setSdeWidth: function(width) {
            $(".sde-editor").css("width",width);
            $("#edui45").css("width",width);

            $("#myEditor").css("width",width);
            $("#edui45_iframeholder").css("width",width);
            return "" ;
        },
	    /**
	    ...
	    getAllControl: function(selector) {
	        ...
	        for (var i = 0, l = AllControl.length; i < l; i++) {
                ...
                if(goal) controls.push(goal);
	        }
	        return controls;
	    },
        /**
         * No16.1 根据控件json，组装goal
         */
        pluginJsonToGoal:function(jsonStr){
            var goal = null;
            if (jsonStr != null && jsonStr != '') {
                goal = {
                    goal_code: jsonStr.ID?jsonStr.ID:jsonStr.CODE,
                    goal_name: jsonStr.NAME||"",
                    goal_value: jsonStr.VALUE||"",
                    goal_type: jsonStr.TYPE,
                    goal_desc: jsonStr.DESCNAME||"",
                    goal_tag: jsonStr.TAG||"",
                    plugin_ver_id: jsonStr.VER_ID,
                    conn_rule_code: jsonStr.RULE||"",
                    conn_template_ver_id: jsonStr.CONN_TEMPLATE_VER_ID||"",
                    conn_plugin_code: jsonStr.CONNCODE||""
                };
            }
            return goal;
        },
	    /**
		 * No16.2. 根据id获取key_value
		 */
	    getControlByParam: function(param) {
	    	var controls = [];
	        var AllControl = this.sdes.getControlByParam(param);
	        for (var i = 0, l = AllControl.length; i < l; i++) {
                var goal = this.pluginJsonToGoal(AllControl[i]);
                if(goal) controls.push(goal);
	        }
	    ...
	    /**
		 * No17. 将数据设置到报告中，防止出现不存在的code报错
		 */
	    setEditorCodeValue: function(code, value) {
	    	//空值校验
	    	if(!code) return false;
	    	var codeObj = this.querySelector("#"+code);
	    	if(!codeObj) return false;
	    	this.setControl({  ID: code, VALUE: value });
	    	return true;
	    },

	    /**
		 * No18. 获取报告code值，防止出现不存在的code报错
		 */
	    getEditorCodeValue: function(code) {
	    	//空值校验
	    	if(!code) return false;
	    	var codeObj = this.querySelector("#"+code);
	    	if(!codeObj) return null;
	    	return this.getControl(code).VALUE;
	    },
	    /**
		 * No19. 清空编辑内容在将content内容加载到编辑器
		 */
	    clearLoad: function(content) {
	        sde.setExecCommand('cleardoc');
	        this.inserthtml(content ? content: "");
	    },
	    /**
		 * No20. 插入一个文本域
		 */
	    inserTextarea: function(param) {
	        var defaults = {};
	        defaults.id = 'imgId';
	        defaults.name = 'imgName';
	        defaults.rows = 4;
	        defaults.cols = 20;
	        defaults.text = '';
	        param = $.extend(true, defaults, param);
	        this.inserthtml('<textarea id="' + param.id + '" name="' + param.name + '" rows="' + param.rows + '"  cols="' + param.cols + '">' + param.text + '</textarea>');
	    },
	    /**
		 * No21. 插入一个占位图
		 */
	    insertPic: function(param) {
	        var defaults = {};
	        defaults.id = 'imgId';
	        defaults.name = 'autopic';
	        defaults.width = 300;
	        defaults.height = 200;
	        defaults.title = 'img';
	        param = $.extend(true, defaults, param);
	        this.inserthtml('<img id="' + param.id + '" name="' + param.name + '" width="' + param.width + '" height="' + param.height + '" />');
	    },
	    /**
		 * No22.1. 插入一个按钮
		 */
	    createButton: function(param) {
	        // this.inserthtml('<button id="'+param.id+'" name="'+param.name+'" style="'+param.style+'"  onclick="'+param.onclick+'">'+param.title+'</button>');
	        var param = {
	            name: 'dialog',
	            title: '插入按钮',
	            width: 600,
		 ...
		 * No22. 插入一个按钮
		 */
	    insertButton: function(param) {
	        var defaults = {};
	        defaults.onclick = 'window.parent.testVop()';
	        defaults.title = 'button';
	        defaults.style = '';
	        defaults.id = 'btnId';
	        defaults.name = 'btnName';
	        param = $.extend(true, defaults, param);
	        this.inserthtml('<button id="' + param.id + '" name="' + param.name + '" style="' + param.style + '"  onclick="' + param.onclick + '">' + param.title + '</button>');
	    },
	    /**
	    ...
	    createDialog: function(option) {
	        // 默认属性
	        var defaults = {
	            iframeUrl: window.SDE_CONFIG.HOME_URL_DIALOGS + 'button/test.vop',
	            name: 'dialog',
	            title: '弹框',
	            width: 600,
	            height: 300,
	            ok: function() {
	                var param = {
	                    onclick: 'window.parent.testVop()',
	                    title: '插入dialog'
	                };
	                this.inserthtml('<button onclick=' + param.onclick + '>' + param.title + '</button>');
	            },
	            cancel: function() {
	                // console.log('点击了取消事件');
	            }
	        ...
	        if (typeof option === 'string') {
	            defaults.uiName = defaults.label = option;
	        }

	        /*
			 * $.extend 可以将src1,src2,src3...进行合并，然后将合并结果返回给newSrc了。 如下例：
	        ...
	        var dialog = new UE.ui.Dialog({
	            ...
	            title: option.title,
	            // 指定dialog的外围样式
	            cssRules: "width:" + option.width + "px;height:" + option.height + "px;",
	    ...
	    getDialog: function(param) {
	        var dialog = this.createDialog(param);
	        UE.registerUI('modify', dialog);
	        // 渲染dialog
	        dialog.render();
	        dialog.open();
	    },
	    /**
		 * No25. 插入一个表格，如果没有行数列数，默认3行5列
		 */
	    insertTable: function(numRows, numCols) {
	        if (numRows === void 0) numRows = 3; // 行
	        if (numCols === void 0) numCols = 5; // 列
	        this.__ue__.execCommand("inserttable", {
	            numRows: numRows,
	            numCols: numCols
	        })
	    },
	    /**
		 * No26. 获取querySelector
		 */
	    querySelector: function(param) {
	        return this.sdes.__dom__.querySelector(param);
	    },
	    /**
		 * No26.1 获取querySelectorAll
		 */
	    querySelectorAll: function(param) {
            return this.sdes.__dom__.querySelectorAll(param);
	    },
        /**
         * No26.2 JQ获取
         */
        jqSelectorAll: function(param) {
         ...
         * @description
         */
        restoreRevise:function( ) {
            var $data = this.jqSelectorAll(".span-revise");
            $data.hide();
            var $data2 = this.jqSelectorAll(".span-revise-edit");
            $data2.hide();
            var $data3 = this.jqSelectorAll("[revise_class]");
            $data3.hide();
        },
        /**
         * No27.1 清除修改痕迹
         ...
         * @description
         */
        cleanRevise:function( ) {
            var $data = this.jqSelectorAll(".span-revise");
            $data.hide();
            var $data2 = this.jqSelectorAll(".span-revise-edit");
            $data2.attr("revise_class",$data2.attr("class"));
            $data2.removeAttr("class");
        ...
        showAllRevise:function( ) {
            ...
            var $data3 = this.jqSelectorAll("[revise_class]");
            $data3.show();
            $data3.addClass($data3.attr("revise_class"));
            $data3.removeAttr("revise_class");
         ...
         * @description
         */
        getRevEditHtml:function( ) {
            var data = this.jqSelectorAll(".span-revise-edit");
            var datas=[];
            for(var i=0,datal=data.length; i<datal;i++){
                datas.push(data[i].outerHTML);
            }
            return datas;
        },
        /**
		 ...
		 * No28. disSDEButton
		 */
	    disSDETable: function() {
	    	var id = ".sde-table",css = "sde_table_dis";
	    	return this.__ue__.cleanSDE(id,css);
	    },
	    /**
		 * No28.1 disSDEButton
		 */
	    disSDEButton: function() {
	    	var id = "button";
	    	return this.__ue__.cleanSDE(id);
	    },
	    /**
		 * No29.转大写
		 */
		 ...
		 * No30. 修改编辑器内控件
		 */
	    updateControl: function(param) {
	    	try {
	    		var paramObj = this.jsonKeyToUpperCase(param),
	    			objs = this.querySelectorAll("#" + paramObj.CODE);
	    		for ( var i = 0, l = objs.length; i < l; i++) {
	    			var obj = objs[i];
	    			var n = obj.getAttribute("sde-model"),
	    				jsonstr = JSON.parse(n);
	    			jsonstr.VALUE = paramObj.VALUE;
	    			var sdeValue = obj.getElementsByClassName("sde-value")[0];
	    			if (void 0 !== paramObj.READONLY) {
	    				jsonstr.READONLY = paramObj.READONLY;
	    				var boo = "true";
	    				if (1 === jsonstr.READONLY) {
	    					boo = "false";
	    				}
	    				sdeValue.setAttribute("contenteditable", boo);
	    			}
	    			if (void 0 !== paramObj.TEXT || "select" === paramObj.TYPE) {
	    				jsonstr.TEXT = paramObj.NAME;
	    				sdeValue.innerText = paramObj.NAME?paramObj.NAME:'';

	    			} else if (void 0 !== paramObj.TEXT || "checkbox" === paramObj.TYPE) {
	    				var iCheckbox = obj.querySelectorAll("input[type=checkbox]");
	    				for ( var l = 0, c = iCheckbox.length; l < c; l++) {
	    					var d = iCheckbox[l], u = !1, h = d.getAttribute("value");
	    					for ( var f = 0, p = paramObj.VALUE.length; f < p; f++) {
	    						if (paramObj.VALUE[f].VALUE === h) {
	    							u = !0;
	    							break
	    						}
	    					}
	    				...
	    				sdeValue.innerText = paramObj.VALUE?paramObj.VALUE:''
	    			}
	    			obj.setAttribute("_updateTime", new Date().getTime())
	    			obj.setAttribute("title", paramObj.NAME?paramObj.NAME:'')
	    			obj.setAttribute("sde-model", JSON.stringify(paramObj))
	    		}
	    	} catch (e) {
	    		console.log('paramObj：' + JSON.stringify(paramObj) + ',e=' + e);
	    	}
	    },
	    /**
		 * No31. 设置页眉内容
		 */
	    setPageHead : function(val) {
	    	val = '<div class = "page-head">'+val +'</div>';
	    	window.SDE_CONFIG.SDE_PAGEHEAD = val;
		},
		/**
		 * No32. 设置页脚内容
		 */
		setPageFoot : function(val) {
	    	val = '<div class = "page-foot">'+val +'</div>';
	    	window.SDE_CONFIG.SDE_PAGEFOOT = val;
		},
		/**
		 * No33. 获取页眉内容
		 */
		getPageHead : function(val) {
	    	return window.SDE_CONFIG.SDE_PAGEHEAD;
		},
		/**
		 * No34. 获取页脚内容
		 */
		getPageFoot : function(val) {
			return window.SDE_CONFIG.SDE_PAGEFOOT;
		},
        /**
         * No35.删除sde元素
         */
         ...
         */
        isContentchagne : function(param) {
            return window.SDE_CONFIG.IS_CONTENTCHAGNE !=='0';
        }
        ,
        /**
         * No37.单个病程不可编辑
         */
        recordReadonly : function(id) {
            var _obj = sde.querySelector(id);

            var _html = _obj.innerHTML;
            _html = _html.replace(/(\r\n)|(\n)/g,'<br>');
            _obj.innerHTML = _html;

            _obj.setAttribute("contenteditable","false");
            var t = $(_obj).find('[contenteditable="true"]');
            if (t.length > 0)
            ...
            var plaintextOnly = $(_obj).find("[contenteditable=plaintext-only]");
        ...
        iconMark : function(param){		//传入 0或不传值 ：关闭            传入1：打开
            ...
            $(sdemodel).each(function(){
                var $sdeR = $(this).find(".sde-right");
                var json;
                try{
                    json = JSON.parse($(this).attr("sde-model"));
                }catch(e){}
                if(!(json && json.TYPE)) return true;

                switch(json.TYPE){
                    case "date":
                        param == 1||param == '1' ? $sdeR.addClass("own_icon_date") : $sdeR.removeClass("own_icon_date");
                        break;
                    case "select":
                        //针对不同下拉框，用不同图标标记 --start Nothing 2017-11-24
                        if(json.VERIFYTYPE == "checkbox"){
                            param == 1||param == '1' ? $sdeR.addClass("own_icon_checkbox") : $sdeR.removeClass("own_icon_checkbox");
                        }else{
                            param == 1||param == '1' ? $sdeR.addClass("own_icon_select"): $sdeR.removeClass("own_icon_select");
                        }
                        break;
                    case "text":
                        param == 1||param == '1' ? $sdeR.addClass("own_icon_text") : $sdeR.removeClass("own_icon_text");
                        break;
                    case "checkbox":
                        if(json.VERIFYTYPE == "radio"){
                            param == 1||param == '1' ? $sdeR.addClass("own_icon_radio") : $sdeR.removeClass("own_icon_radio");
                        }else{
                            param == 1||param == '1' ? $sdeR.addClass("own_icon_checkbox"): $sdeR.removeClass("own_icon_checkbox");
                        }
                        break;
         ...
         * No41.多图上传占位图宽度可调节
         */
        uploadPicWidth : function(param){  //1开  0关
            sde.__proto__.uploadPicWidth_switch = param;
            return sde.__proto__.uploadPicWidth_switch;
        },
        /**
         * No42.获取控件得分情况
         */
        getControlScore : function(param) {
            return this.sdes.getControlScore(param);
        },
        /**
         * No42.1. 判断是否是计算表达式
         * 返回!1，不是计算表达式
         * 返回!0，是计算表达式
         */
        isSDEExpStr : function(show) {
            var boo = !1;
            if(show && show.indexOf("$") >= 0 ){
                boo  = !0;
            }
            return boo;
        },
         ...
         * No42.2. math提供的方法
 window.SDEMATH = [
         'LN2','LN10','LOG2E','LOG10E','PI','SQRT1','SQRT2',
         'abs','acos','asin','atan','atan2','ceil','cos','exp','floor','log','max','min','pow','random','round','sin','sqrt','tan','toSource','valueOf'];

         */
        expReplaceMath : function(str) {
            str = str.replace(/\$/g,"score.");
            str = str.replace(/abs\(/g,"Math.abs(");
            str = str.replace(/ceil\(/g,"Math.ceil(");
            str = str.replace(/floor\(/g,"Math.floor(");
            return str;
        },
        /**
         * No42.3.解析计算表达式中的code
         * 20180111 king 控件值变化时,自动计算表达式
         */
        expStrToSetCode:function(param){
            var expStr = param || "(($buwei1+$buwei2)-($buwei3+$buwei4))/($buwei1+$buwei2+$buwei3+$buwei4)*0.5" ;
            //expStr="if(($LC+$LW)>($RC+$RW)){ $LC+$LW}else{$RC+$RW}";
            //console.log(expStr.toString());
            var arr = expStr.split("$");
            for(var i in arr){
                var si = arr[i].search(/(abs)|(ceil)|(floor)|(\=)|(\<)|(\>)|(\()|(\))|(\+)|(\-)|(\*)|(\/)|(if)|(else)|(\{)|(\})/g);
                if(si && si==-1){continue;}
                arr[i] = arr[i].substring(0,si);
            }
            var sets = new Set(arr);
            var expArr = Array.from(sets);
            console.log(expArr.toString());
            return expArr;
        },
        ...
        checkPluginLR : function(A) {
            return this.sdes.checkPluginLR(A);
        },
        /**
         * No44.统计打印页数
         */
        setPageBreak : function(param){      //传入1，添加打印页背景色，仅作测试
            var len = $("#ueditor_0").contents().find("#measure").length;
            if(len == 0)$("#ueditor_0").contents().find("body").wrapInner("<div id='measure' class='measure_pos'>");
            $("#ueditor_0").contents().find("#measure").append("<div class='measureH' style='height:274.7mm;top: 0'></div>");
            var aHeight = $("#ueditor_0").contents().find("#measure").height();
            var sHeight = $("#ueditor_0").contents().find(".measureH").height();
            var num = Math.floor(aHeight/sHeight);
            if(arguments.length >0 ){
                if(num >=1) {
                    $("#ueditor_0").contents().find("body").find("#measure").css({"border": "1px solid red"});
                    $("#ueditor_0").contents().find(".measureH").css({"background": "pink"});
                    for (var i = 1; i < num; i++) {
                        var color = '';
                        if (i % 3 == 1) {
                            color = "red";
                        ...
                        //$("#ueditor_0").contents().find("#measure").append("<div class='measureH' style='top:"+ i*278 +"mm';>"+"</div>")
                        $("#ueditor_0").contents().find("#measure").append("<div class='measureH' style='background:" + color + ";top:" + i * 278 + "mm'>" + "</div>")
                    }
                }
            }else{
                $("#ueditor_0").contents().find("#measure").css({"border":"none",}).removeClass("measure_pos");
                $("#ueditor_0").contents().find(".measureH").remove();
            }

            return num+1;
        },
        /**
         * No45.获取单选控件的左侧描述及选中值
         */
        getRadioVal:function(){
                var arr = sde.getControl().filter(function(item){
                    return item.VERIFYTYPE == "radio" && item.LABEL!= ""
                });
                var str = "",val="",len = arr.length,tempArr=[];
                for(var i = 0 ; i <len ; i++){
                    val = arr[i].VALUE;
                    if(val == "") continue;
                    tempArr = arr[i].BINDINGDATA.filter(function(item){
                        return item.VALUE == val;
                    });
                    str += arr[i].LABEL + "-" + tempArr[0].TEXT+"; "
                }
                return str;
        },
        /**
         * No46.
         */
        treeAddPlugin:function(){
            console.log("treeAddPlugin");

        },
        /**
         * No46.1
         */
        treeAppendPlugin:function(){
            console.log("treeAppendPlugin");
        },
        /**
         * No46.2
         */
...
UE.plugins['checkbox'] = function () {
    var _url = window.SDE_CONFIG.HOME_URL_DIALOGS + 'button/button.vop',
        me = this,
        thePlugins = 'checkbox',
        cssRules = "width:600px;height:400px;",
        title = '心血管内科';
    me.commands[thePlugins] = {
        execCommand: function (cmdName, param1, param2) {

            var dialog = new UE.ui.Dialog({
                iframeUrl: _url,	// 弹出模式以iframe方式打开的控件配置页面 URL
                name: thePlugins,
                editor: me,
                title: title,		// 弹出框标题
                cssRules: cssRules,
            ...
            var ss = baidu.editor.sdeplugins['ttt'];
            ss.param1 = param1, ss.param2 = param2;
...
/*二维码、条形码--start*/
UE.plugins['sdecontrolqrcode'] = function() {
    var url = this.options.UEDITOR_HOME_URL;
    var butt = window.SDE_CONFIG.HOME_URL_DIALOGS + 'qrcode.vop';
    var me = this, thePlugins = 'sdecontrolqrcode';
    me.commands[thePlugins] = {
        execCommand : function() {
            var dialog = new UE.ui.Dialog({
    ...
    me.addListener(
        ...
        function(t, evt) {
            ...
            if (/input/ig.test(el.tagName)
                && leipiPlugins == thePlugins) {
                var html = popup
                    .formatHtml('<nobr>二维码: <span onclick=$$._edittext() class="edui-clickable">编辑</span>  <span onclick=$$._delete() class="edui-clickable">删除</span></nobr>');
                if (html) {
...
UE.plugins['sdecontrolbarcode'] = function() {
    var url = this.options.UEDITOR_HOME_URL;
    var butt = window.SDE_CONFIG.HOME_URL_DIALOGS + 'barcode.vop';
    var me = this, thePlugins = 'sdecontrolbarcode';
    me.commands[thePlugins] = {
        execCommand : function() {
            var dialog = new UE.ui.Dialog({
                // 弹出模式以iframe方式打开的控件配置页面 URL
    ...
    me.addListener(
        ...
        function(t, evt) {
            ...
            if (/input/ig.test(el.tagName)
                && leipiPlugins == thePlugins) {
                var html = popup
                    .formatHtml('<nobr>条形码: <span onclick=$$._edittext() class="edui-clickable">编辑</span>  <span onclick=$$._delete() class="edui-clickable">删除</span></nobr>');
                if (html) {
                    popup.getDom('content').innerHTML = html;
                    popup.anchorEl = el;
                    popup.showAnchor(popup.anchorEl);
