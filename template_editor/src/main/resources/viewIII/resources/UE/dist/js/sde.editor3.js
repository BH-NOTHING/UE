...
function(e, t, n) {
    ...
    txtCheck=function(param,t){
        ...
        var res = sde.analyCheck(sdeJson.TEXTCHECK,sdeJson.VALUE);
            ...
            if (MIP_MRHP) {
                ...
                if (!Array.isArray(MIP_MRHP)) {
                 ...
                 for (var ii = 0, al = arrs.length; ii < al; ii++) {
                    var arr = arrs[ii];
                    var aa = $(arr);
                     bootemp = sde.sdecontains(aa, _obj);
                    if (bootemp) {
                        break;
                    }
                }
            ...
            c = function(e) {
                ...
                n = (t.getAttribute("sde-model"),
                    ...
                    if (nn.isCollapsed && 0 === nn.anchorOffset && 0 === nn.focusOffset) {
                        var ii = nn.anchorNode.previousElementSibling;
