...
(function(){
    ...
    function initTabs(){
        ...
        domUtils.removeClasses($G(tabs[1].getAttribute('data-content-id')), 'focus');
    ...
    function insertUpload(){
        var videoObjs=[],
            ...
            width = parseInt($G('upload_width').value, 10) || 38,
            height = parseInt($G('upload_height').value, 10) || 48,
        ...
        for(var key in uploadVideoList) {
            ...
            videoObjs.push({
                ...
                isFastdfsRes: file.isFastdfsRes,
                title: file.title,
                size: file.size,
                align:align
            });
                ...
                try {
                    ...
                    if (json.state == 'SUCCESS') {
                        uploadVideoList.push({
                            'url': json.url,
                            'type': json.type,
                            'isFastdfsRes': json.isFastdfsRes,
